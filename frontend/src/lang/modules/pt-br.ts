...
const message = {
    ...
    xpack: {
        ldap: {
            source: 'Origem',
            directoryMissing: 'Não encontrado no LDAP',
            localCredentialsManaged:
                'O nome de usuário e a senha são gerenciados pelo LDAP e não podem ser alterados localmente.',
            sources: {
                local: 'Local',
                ldap: 'LDAP',
            },
            importUsers: 'Importar usuários AD/LDAP',
            searchUsersPlaceholder: 'Pesquisar nome de usuário',
            readFromLDAP: 'Leia de LDAP',
            selectedUsers: '{0} selecionado',
            queriedAt: 'Lido em',
            cachedResult: 'Resultado armazenado em cache',
            roleForNewUsers: 'Função para novos usuários',
            selectRole: 'Selecione uma função',
            roleOnlyForNewUsers: 'Uma função é necessária somente quando a importação cria usuários.',
            roleRequiredForNewUsers: 'Selecione uma função para novos usuários LDAP.',
            changedFields: 'Campos alterados',
            importSelected: 'Importação selecionada',
            importAll: 'Importar tudo',
            importPreview: 'Pré-visualização da importação AD/LDAP',
            importCompleted: 'Importação AD/LDAP concluída',
            incompletePreview: 'A leitura do diretório LDAP estava incompleta. Leia LDAP novamente.',
            missingUsersWarning: 'Os usuários ausentes de LDAP serão desabilitados pela sincronização estrita.',
            missingUsersWarningDetail: '{0} usuários LDAP locais não poderão mais fazer login.',
            action: 'Ação',
            reason: 'Razão',
            noImportChanges: 'Nenhuma alteração de importação',
            confirmImport: 'Confirmar importação',
            created: 'Criar',
            updated: 'Atualizar',
            reactivated: 'Reativar',
            unchanged: 'Inalterado',
            conflicts: 'Conflitos',
            missing: 'Desaparecido',
            missingUsersConfirm: 'Usuários {0} ausentes em LDAP serão desabilitados e desconectados. Continuar?',
            strictSyncConfirm: 'Confirme a sincronização estrita',
            status: {
                importable: 'Novo usuário',
            ...
            fields: {
                ...
                externalDN: 'Diretório DN',
                externalID: 'ID externo',
                authSourceStatus: 'Status de autenticação',
            },
            actions: {
                created: 'Criar',
                updated: 'Atualizar',
        ...
        user: {
            ...
            auth: {
                ...
                providerDescriptions: {
                    ldap: 'Compatível com Active Directory, OpenLDAP e outros serviços LDAP',
                    passkey: 'Use credenciais do dispositivo para login sem senha',
                    radius: 'Autenticar o acesso à rede através de um serviço Radius',
                    oidc: 'Conecte o logon único empresarial com OpenID Connect',
                    saml2: 'Use SAML2 para federação de identidade corporativa',
                    cas: 'Conecte um serviço de autenticação centralizado para logon único',
                    oauth2: 'Conecte um serviço de identidade OAuth2 compatível',
                    dingtalk: 'Use a identidade da organização DingTalk e login QR',
                    feishu: 'Use a identidade da organização Feishu e a sincronização de contas',
                    wecom: 'Autenticar com identidade de membro WeCom',
                },
                planned: 'Planejado',
                plannedTitle: 'Configurações de autenticação {0}',
                plannedDesc: 'Este provedor de autenticação está planejado e ainda não está disponível.',
                ldap: {
                    enable: 'Habilitar',
                    enabled: 'Habilitado',
                    disabled: 'Desativado',
                    ...
                    connectionDesc:
                        'Configure o serviço de diretório e a conta de ligação usada para procurar usuários.',
                    serverURL: 'URL do servidor',
                    serverURLHelper: 'Suporta URLs ldap:// e ldaps://.',
                    userBaseDN: 'Base DN do usuário',
                    userBaseDNHelper:
                        'DN inicial para pesquisas de usuários LDAP; pode ser uma OU, um CN ou o DN raiz do domínio.',
                    bindDN: 'DN de vínculo',
                    bindPassword: 'Senha',
                    ...
                    testLogin: 'Testar login',
                    userImport: 'Importar usuários',
                    saveBeforeImport: 'Salve as configurações AD/LDAP atuais antes de importar usuários.',
                    format: 'Formato',
                    restoreExample: 'Exemplo de restauração',
                    mappingValid: 'JSON válido; name está configurado.',
                    mappingInvalid: 'Insira JSON válido.',
                    mappingObject: 'O mapeamento de atributos deve ser um objeto JSON.',
                    mappingOnlyName: 'Somente o mapeamento name é suportado.',
                    mappingStringValues: 'Cada atributo mapeado deve ser uma string.',
                    mappingNameRequired: 'name deve ser uma sequência não vazia.',
                    restored: 'As últimas configurações salvas foram restauradas.',
                    connectionTestSuccess: 'O teste de conexão LDAP foi bem-sucedido.',
                    recentTestSuccess: 'Último teste bem-sucedido: {0}',
                    recentTestFailed: 'Último teste falhou: {0}',
                    serverURLRequired: 'Insira a URL do servidor LDAP.',
                    serverURLInvalid: 'Use um URL ldap:// ou ldaps:// válido.',
                    userBaseDNRequired: 'Informe a Base DN do usuário.',
                    bindDNRequired: 'Insira a ligação DN.',
                    passwordRequired: 'Digite a senha.',
                    userFilterRequired: 'Insira o filtro do usuário.',
                    connectTimeoutRequired: 'Insira o tempo limite de conexão.',
                    searchPageSizeRequired: 'Insira o tamanho da página de consulta LDAP.',
                    sync: {
                        ...
                        previewTitle: 'Próximas 5 execuções',
                        previewEmpty: 'Não há tempo de execução disponível',
                        cronHelper:
                            'Use uma expressão Cron padrão de cinco campos: minuto, hora, dia, mês, dia da semana.',
                        autoImport: 'Importar novos usuários',
                        autoImportHelper:
                            'Quando desativado, apenas os identificadores e o status do diretório são mantidos para usuários LDAP importados; nenhum novo usuário é criado.',
                        defaultRole: 'Nova função de usuário',
                        ...
                        lastRunRunning: 'Sincronização iniciada: {0}',
                        sourceDisabled: 'Habilite e salve AD/LDAP antes de executar a sincronização.',
                        cronRequired: 'Insira uma expressão Cron.',
                    ...
                    syncLogs: {
                        ...
                        description: 'Revise os resultados da sincronização LDAP programada e manual.',
                        startedAt: 'Hora de início',
                        trigger: 'Tipo de execução',
                        manual: 'Manual',
                        scheduled: 'Agendado',
                        success: 'Sucesso',
                        failed: 'Falha',
                        running: 'Em execução',
                        result: 'Resultado',
                        resultSummary: 'Criados {0}, atualizados {1}, ausentes {2}',
                        duration: 'Duração',
                        action: 'Ação',
                    },
                    ...
                    testLoginSuccess: 'Autenticação bem-sucedida.',
                    testLoginSuccessWithDN: 'Autenticação bem-sucedida. Usuário DN: {0}',
                    import: {
                        title: 'Importar usuários AD/LDAP',
                        source: 'Fonte de dados: diretório AD/LDAP',
                        lastRead: 'Última leitura: {0}',
                        cacheHit: 'Resultado armazenado em cache',
                        keywordPlaceholder: 'Pesquisar nome de usuário',
                        search: 'Pesquisar',
                        refresh: 'Leia de LDAP',
                        refreshTip: 'Ignore o cache de curto prazo e leia o diretório LDAP novamente.',
                        loadFailed: 'Falha ao ler o diretório LDAP.',
                        retry: 'Tentar novamente',
                        noData: 'Nenhum usuário do diretório encontrado.',
                        ...
                        upToDate: 'Atualizado',
                        conflict: 'Conflito de nome',
                        selectedCount: '{0} selecionado',
                        totalCount: '{0} usuários',
                        newUserRole: 'Nova função de usuário',
                        newUserRoleRequired: 'Selecione uma função para novos usuários.',
                        noNewUsers: 'Não há novos usuários nesta operação.',
                        roleOnlyForNewUsers: 'A função selecionada é aplicada somente aos usuários recém-criados.',
                        strictOff:
                            'A sincronização estrita está desativada. Uma importação completa não desativará os usuários.',
                        importSelected: 'Importação/atualização selecionada ({0})',
                        importAll: 'Importar/atualizar tudo ({0})',
                        previewTitle: 'Confirme a importação completa',
                        previewDesc:
                            'O diretório LDAP completo foi lido. A palavra-chave de pesquisa não limita esta operação.',
                        created: 'Criar',
                        updated: 'Atualizar',
                        unchanged: 'Inalterado',
                        conflicts: 'Conflitos',
                        ...
                        reactivated: 'Reativar',
                        strictWarning:
                            'A sincronização estrita está habilitada. Os usuários ausentes de LDAP não podem fazer login, mas seus registros, funções e permissões são mantidos.',
                        missingUsers: 'Usuários ausentes em LDAP',
                        missingScope: 'Somente esta fonte LDAP é afetada.',
                        willDisable: 'Será desativado',
                        confirmAll: 'Confirmar importação',
                        confirmAllWithMissing: 'Confirmar importação e desabilitar {0} usuários',
                        executeSuccess: 'Os usuários LDAP foram processados com sucesso.',
                        queryExpired: 'O resultado do diretório expirou. Leia LDAP novamente.',
                        planIncomplete: 'A leitura completa do diretório está incompleta e não pode ser executada.',
                    },
                },
            },
        },
