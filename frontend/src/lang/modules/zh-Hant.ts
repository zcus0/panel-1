...
const message = {
    ...
    aiTools: {
        agents: {
            ...
            discoverModelsFailedUseDefaults: '取得模型失敗，已使用預設模型',
            ...
            validateAvailabilityHelper: '儲存前傳送最小訊息驗證介面可用性',
            validateImageAvailabilityHelper: '儲存前會實際產生一張最小圖片，可能產生費用',
        },
        model: {
            model: '模型',
            localModel: '本地模型',
    ...
    toolbox: {
        ...
        clam: {
            ...
            alertHelper: 'OSS 版支援定時掃描和簡訊告警功能',
    ...
    setting: {
        ...
        proxyHelper2: '系統版本升級及取得更新說明',
        proxyHelper3: '系統許可證的驗證和同步',
        proxyHelper4: 'Docker 拉取映像等網路請求將透過代理伺服器存取',
        proxyHelper5: '系統類型腳本庫的統一下載與同步',
        proxyHelper6: '申請憑證',
        proxyType: '代理類型',
        proxyUrl: '代理地址',
        proxyPort: '代理埠',
    ...
    license: {
        ...
        licenseAlert: '僅當許可證正常綁定到節點時，該許可證才能新增節點，只有正常綁定到許可證的節點支援切換。',
        licenseUnbindHelper: '偵測到該許可證存在節點，請解除綁定後重試',
        subscription: '訂閱',
        perpetual: '永久授權',
        product: '產品',
        ...
        authorizedUser: '被授權方',
        lostHelper: '許可證已達到最大重試次數，請手動點選同步按鈕，以確保功能正常使用，詳情：',
        exceptionalHelper: '許可證同步驗證異常，請手動點選同步按鈕，以確保功能正常使用，詳情：',
        quickUpdate: '快速更新',
        power: '授權',
        unbindHelper: '解除綁定後將清除該節點所有相關設定，是否繼續？',
        importLicense: '匯入許可證',
        ...
        licenseRequiredUserTip: 'OSS 版許可證未綁定，請聯絡超級管理員匯入許可證。',
        levelUpPro: '',
        licenseSync: '許可證同步',
        knowMorePro: '了解更多',
        ...
        serialNo: '序號',
        remark: '備註',
        waf: '可以獲得攔截地圖、日誌、封鎖記錄、地理位置封禁、自訂規則、自訂攔截頁面等功能。',
        tamper: '可以保護網站免受未經授權的修改或篡改。',
        tamperHelper: '操作失敗，該檔案或資料夾已經開啟防篡改，請檢查後重試',
        setting: '可以自訂面板 Logo、歡迎簡介等資訊。',
        monitor: '可以檢視網站的即時狀態、訪客趨勢、訪客來源、請求日誌等資訊。',
        alert: '可透過簡訊接收告警資訊，並檢視告警日誌，全面掌控各類關鍵事件，確保系統執行無憂。',
        node: '可以使用 1Panel 管理多台 Linux 伺服器。',
        nodeApp: '可以統一升級多節點應用版本，無需手動切換節點。',
        nodeDashboard: '可以集中管理多節點應用、網站、資料庫和計劃任務。',
        fileExchange: '可以在多台伺服器之間快速傳輸檔案。',
        app: '可透過手機APP，檢視服務資訊、異常監控等。',
        cluster: '可以管理 MySQL/Postgres/Redis 主從叢集。',
        vllm: '可將 vLLM 服務統一納入 1Panel 管理，集中完成部署、設定調整、狀態維運與任務追蹤，降低本地模型服務維護成本。',
        'model-downloader':
            '可從 HuggingFace、ModelScope 或相容鏡像站搜尋、下載並管理本機模型檔案，統一維護本機模型目錄與下載任務。',
    },
    clean: {
        scan: '開始掃描',
    ...
    xpack: {
        ldap: {
            source: '來源',
            directoryMissing: 'LDAP 中不存在',
            localCredentialsManaged: '此使用者的使用者名稱和密碼由 LDAP 管理，無法在本機修改。',
            sources: {
                local: '本機',
                ldap: 'LDAP',
            },
            importUsers: '匯入 AD/LDAP 使用者',
            searchUsersPlaceholder: '搜尋使用者名稱',
            readFromLDAP: '從 LDAP 讀取',
            selectedUsers: '已選擇 {0} 項',
            queriedAt: '讀取時間',
            cachedResult: '快取結果',
            roleForNewUsers: '新使用者角色',
            selectRole: '請選擇角色',
            roleOnlyForNewUsers: '僅在本次處理包含新使用者時需要選擇角色。',
            roleRequiredForNewUsers: '請為新的 LDAP 使用者選擇角色。',
            changedFields: '變更欄位',
            importSelected: '匯入/更新所選',
            importAll: '匯入/更新全部',
            importPreview: 'AD/LDAP 匯入預覽',
            importCompleted: 'AD/LDAP 使用者處理完成',
            incompletePreview: 'LDAP 目錄未完整讀取，請重新從 LDAP 讀取。',
            missingUsersWarning: '嚴格同步將停用 LDAP 中不存在的使用者。',
            missingUsersWarningDetail: '{0} 個本機 LDAP 使用者將無法繼續登入。',
            action: '處理結果',
            reason: '原因',
            noImportChanges: '沒有需要處理的變更',
            confirmImport: '確認匯入',
            created: '新增',
            updated: '更新',
            reactivated: '恢復',
            ...
            conflicts: '衝突',
            missing: '將停用',
            missingUsersConfirm: 'LDAP 中不存在的 {0} 個使用者將被停用並登出，是否繼續？',
            strictSyncConfirm: '確認嚴格同步',
            status: { importable: '可匯入', update_available: '待更新', up_to_date: '已是最新', conflict: '同名衝突' },
            fields: { name: '使用者名稱', externalDN: '目錄 DN', externalID: '外部識別', authSourceStatus: '認證狀態' },
            actions: {
                created: '新增',
                updated: '更新',
                reactivated: '恢復',
        ...
        expiresEnterpriseAlert: '溫馨提醒：您的OSS 版許可證將在 {0} 天後到期，屆時所有OSS 版功能將無法繼續使用。',
        expiresProAlert: '溫馨提醒：您的OSS 版許可證將在 {0} 天後到期，屆時所有OSS 版功能將無法繼續使用。',
        name: 'OSS 版',
        menu: '進階功能',
        upage: 'AI 建站',
        proAlert: '以使用此功能',
        ...
        user: {
            ...
            auth: {
                ...
                providerDescriptions: {
                    ldap: '相容 Active Directory、OpenLDAP 等 LDAP 服務',
                    passkey: '使用裝置憑證進行無密碼安全登入',
                    radius: '透過 Radius 服務完成網路存取認證',
                    oidc: '使用 OpenID Connect 接入企業單一登入',
                    saml2: '透過 SAML2 完成企業身分聯合登入',
                    cas: '接入集中式認證服務實現單一登入',
                    oauth2: '接入相容 OAuth2 的第三方身分服務',
                    dingtalk: '使用釘釘組織身分和掃碼登入',
                    feishu: '使用飛書組織身分和帳號同步',
                    wecom: '使用企業微信成員身分認證',
                },
                planned: '待接入',
                plannedTitle: '{0} 認證設定',
                plannedDesc: '該認證方式正在規劃中，暫不可用。',
                ldap: {
                    enable: '是否啟用',
                    enabled: '已啟用',
                    disabled: '未啟用',
                    connection: '基礎連線',
                    connectionDesc: '設定目錄服務和用於搜尋使用者的綁定帳號。',
                    serverURL: '伺服器位址',
                    serverURLHelper: '支援 ldap:// 和 ldaps:// 位址。',
                    userBaseDN: '使用者 Base DN',
                    userBaseDNHelper: 'LDAP 使用者搜尋的起始 DN，可使用 OU、CN 或網域根 DN。',
                    bindDN: '綁定 DN',
                    bindPassword: '密碼',
                    passwordSaved: '留空則保留已儲存的密碼',
                    userSearch: '使用者搜尋',
                    userSearchDesc: '設定使用者搜尋基準與過濾器，並映射到 1Panel 使用者名稱欄位。',
                    userFilter: '使用者篩選器',
                    userFilterTooltip: '按使用者名稱查詢時替換 %(user)s，全量讀取時替換為 *。',
                    userFilterHelper: '搜尋和認證時會對使用者名稱執行 LDAP filter escaping。',
                    attributeMap: '映射屬性',
                    attributeMapTooltip: '1Panel 使用者名稱欄位（name）到 LDAP 屬性的 JSON 映射。',
                    attributeMapHelper: '填寫映射到 1Panel 使用者名稱欄位（name）的 LDAP 屬性。',
                    advanced: '進階設定',
                    ...
                    testLogin: '測試登入',
                    userImport: '使用者匯入',
                    saveBeforeImport: '請先儲存目前 AD/LDAP 設定，再匯入使用者。',
                    format: '格式化',
                    restoreExample: '還原範例',
                    mappingValid: 'JSON 格式正確，name 已設定。',
                    mappingInvalid: '請輸入有效的 JSON。',
                    mappingObject: '映射屬性必須是 JSON 物件。',
                    mappingOnlyName: '僅支援 name 映射。',
                    mappingStringValues: '每個映射屬性都必須是字串。',
                    mappingNameRequired: 'name 必須是非空字串。',
                    restored: '已還原為上次儲存的設定。',
                    connectionTestSuccess: 'LDAP 連線測試成功。',
                    recentTestSuccess: '最近測試成功：{0}',
                    recentTestFailed: '最近測試失敗：{0}',
                    serverURLRequired: '請輸入 LDAP 伺服器位址。',
                    serverURLInvalid: '請輸入有效的 ldap:// 或 ldaps:// 位址。',
                    userBaseDNRequired: '請輸入使用者 Base DN。',
                    bindDNRequired: '請輸入綁定 DN。',
                    passwordRequired: '請輸入密碼。',
                    userFilterRequired: '請輸入使用者篩選器。',
                    connectTimeoutRequired: '請輸入連線逾時時間。',
                    searchPageSizeRequired: '請輸入 LDAP 查詢分頁大小。',
                    sync: {
                        title: '定時同步',
                        description: '定期讀取 LDAP 全量使用者，並維護 1Panel 中的 LDAP 使用者。',
                        enable: '是否啟用',
                        enableHelper: '關閉後不再自動執行，仍可手動立即同步。',
                        schedule: '執行週期',
                        daily: '每天',
                        weekly: '每週',
                        customCron: '自訂 Cron',
                        preview: '預覽',
                        previewTitle: '未來 5 次執行',
                        previewEmpty: '暫無可用執行時間',
                        cronHelper: '使用「分 時 日 月 週」五段式 Cron 運算式。',
                        autoImport: '自動匯入新使用者',
                        autoImportHelper: '關閉後，僅維護已匯入 LDAP 使用者的目錄識別與狀態，不會自動建立新使用者。',
                        defaultRole: '新使用者角色',
                        defaultRolePlaceholder: '請選擇角色',
                        ...
                        lastRunRunning: '同步開始時間：{0}',
                        sourceDisabled: '請先啟用並儲存 AD/LDAP，再執行同步。',
                    ...
                    syncLogs: {
                        title: '同步記錄',
                        description: '查看定時和手動 LDAP 同步的執行結果。',
                        startedAt: '開始時間',
                        trigger: '觸發方式',
                        manual: '手動執行',
                        scheduled: '定時執行',
                    ...
                    testLoginTitle: '測試 AD/LDAP 登入',
                    testLoginDesc:
                        '使用 AD/LDAP 使用者憑證執行 bind 驗證，僅測試認證能力，不建立 1Panel 登入工作階段。',
                    ldapUsername: 'LDAP 使用者名稱',
                    usernameRequired: '請輸入 LDAP 使用者名稱。',
                    startTest: '開始測試',
                    testLoginSuccess: '認證成功。',
                    testLoginSuccessWithDN: '認證成功，使用者 DN：{0}',
                    import: {
                        title: '匯入 AD/LDAP 使用者',
                        source: '資料來源：AD/LDAP 目錄',
                        lastRead: '最近讀取：{0}',
                        cacheHit: '使用快取結果',
                        keywordPlaceholder: '搜尋使用者名稱',
                        search: '搜尋',
                        refresh: '從 LDAP 讀取',
                        refreshTip: '忽略短期快取並重新讀取 LDAP 目錄。',
                        loadFailed: 'LDAP 目錄讀取失敗。',
                        retry: '重試',
                        noData: '未找到目錄使用者。',
                        username: '使用者名稱',
                        status: '狀態',
                        ...
                        upToDate: '已是最新',
                        conflict: '同名衝突',
                        selectedCount: '已選擇 {0} 項',
                        totalCount: '共 {0} 個使用者',
                        newUserRole: '新使用者角色',
                        newUserRoleRequired: '請選擇新使用者角色。',
                        noNewUsers: '本次無新使用者。',
                        roleOnlyForNewUsers: '所選角色僅套用於本次新建使用者。',
                        strictOff: '嚴格同步未啟用，全量處理不會停用使用者。',
                        importSelected: '匯入/更新選中（{0}）',
                        importAll: '匯入/更新全部（{0}）',
                        previewTitle: '確認全量處理',
                        previewDesc: '已完整讀取 LDAP 目錄，目前搜尋關鍵字不會縮小本次處理範圍。',
                        created: '新建',
                        updated: '更新',
                        unchanged: '無變化',
                        conflicts: '衝突',
                        ...
                        reactivated: '恢復',
                        strictWarning:
                            '嚴格同步已啟用。LDAP 中不存在的同源使用者將無法繼續登入，但不會刪除使用者、角色和本機權限。',
                        missingUsers: 'LDAP 中不存在的使用者',
                        missingScope: '僅處理目前 LDAP 認證來源。',
                        willDisable: '將停用',
                        confirmAll: '確認匯入',
                        confirmAllWithMissing: '確認匯入並停用 {0} 個使用者',
                        executeSuccess: 'LDAP 使用者處理成功。',
                        queryExpired: '目錄查詢結果已過期，請重新從 LDAP 讀取。',
                        planIncomplete: 'LDAP 目錄未完整讀取，無法執行全量處理。',
                    },
                },
            },
        },
        ...
        node: {
            ...
            syncWithMaster: 'OSS 版將預設同步所有資料，可在節點管理中手動調整同步策略。',
            syncProxy: '系統代理設定',
        ...
        alert: {
            ...
            alertConfigProHelper: 'OSS 版額外支援企業微信、釘釘、飛書及簡訊告警。',
        },
        theme: {
