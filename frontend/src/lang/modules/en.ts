...
const message = {
    ...
    xpack: {
        ldap: {
            source: 'Source',
            directoryMissing: 'Not found in LDAP',
            localCredentialsManaged: 'Username and password are managed by LDAP and cannot be changed locally.',
            sources: {
                local: 'Local',
                ldap: 'LDAP',
            },
            importUsers: 'Import AD/LDAP users',
            searchUsersPlaceholder: 'Search username',
            readFromLDAP: 'Read from LDAP',
            selectedUsers: '{0} selected',
            queriedAt: 'Read at',
            cachedResult: 'Cached result',
            roleForNewUsers: 'Role for new users',
            selectRole: 'Select a role',
            roleOnlyForNewUsers: 'A role is required only when the import creates users.',
            roleRequiredForNewUsers: 'Select a role for new LDAP users.',
            changedFields: 'Changed fields',
            importSelected: 'Import selected',
            importAll: 'Import all',
            importPreview: 'AD/LDAP import preview',
            importCompleted: 'AD/LDAP import completed',
            incompletePreview: 'The LDAP directory read was incomplete. Read from LDAP again.',
            missingUsersWarning: 'Users missing from LDAP will be disabled by strict synchronization.',
            missingUsersWarningDetail: '{0} local LDAP user(s) will no longer be able to sign in.',
            action: 'Action',
            reason: 'Reason',
            noImportChanges: 'No import changes',
            ...
            conflicts: 'Conflicts',
            missing: 'Missing',
            missingUsersConfirm: '{0} user(s) missing from LDAP will be disabled and signed out. Continue?',
            strictSyncConfirm: 'Confirm strict synchronization',
            status: {
                importable: 'New user',
            ...
            fields: {
                name: 'Username',
                externalDN: 'Directory DN',
                externalID: 'External ID',
                authSourceStatus: 'Authentication status',
            },
            actions: {
                created: 'Create',
                updated: 'Update',
        ...
        user: {
            ...
            auth: {
                ...
                providerDescriptions: {
                    ldap: 'Compatible with Active Directory, OpenLDAP, and other LDAP services',
                    passkey: 'Use device credentials for passwordless sign-in',
                    radius: 'Authenticate network access through a Radius service',
                    oidc: 'Connect enterprise single sign-on with OpenID Connect',
                    saml2: 'Use SAML2 for enterprise identity federation',
                    cas: 'Connect a centralized authentication service for single sign-on',
                    oauth2: 'Connect a compatible OAuth2 identity service',
                    dingtalk: 'Use DingTalk organization identity and QR sign-in',
                    feishu: 'Use Feishu organization identity and account synchronization',
                    wecom: 'Authenticate with WeCom member identity',
                },
                planned: 'Planned',
                plannedTitle: '{0} authentication settings',
                plannedDesc: 'This authentication provider is planned and is not available yet.',
                ldap: {
                    enable: 'Enable',
                    enabled: 'Enabled',
                    disabled: 'Disabled',
                    connection: 'Basic connection',
                    connectionDesc: 'Configure the directory service and the bind account used to search for users.',
                    serverURL: 'Server URL',
                    serverURLHelper: 'Supports ldap:// and ldaps:// URLs.',
                    userBaseDN: 'User Base DN',
                    userBaseDNHelper: 'Starting DN for LDAP user searches; it can be an OU, CN, or domain root DN.',
                    bindDN: 'Bind DN',
                    bindPassword: 'Password',
                    passwordSaved: 'Leave blank to keep the saved password',
                    userSearch: 'User search',
                    userSearchDesc:
                        'Set the user search base and filter, then map the LDAP attribute used as the 1Panel name.',
                    userFilter: 'User filter',
                    userFilterTooltip:
                        'Replace %(user)s with the escaped username, or with * for a full directory read.',
                    userFilterHelper: 'Usernames are escaped before they are inserted into the LDAP filter.',
                    attributeMap: 'Attribute mapping',
                    attributeMapTooltip: 'JSON mapping from the 1Panel name field to an LDAP attribute.',
                    attributeMapHelper: 'Set the LDAP attribute mapped to the 1Panel name field.',
                    advanced: 'Advanced settings',
                    ...
                    saveBeforeImport: 'Save the current AD/LDAP settings before importing users.',
                    format: 'Format',
                    restoreExample: 'Restore example',
                    mappingValid: 'Valid JSON; name is configured.',
                    mappingInvalid: 'Enter valid JSON.',
                    mappingObject: 'The attribute mapping must be a JSON object.',
                    mappingOnlyName: 'Only the name mapping is supported.',
                    mappingStringValues: 'Every mapped attribute must be a string.',
                    mappingNameRequired: 'name must be a non-empty string.',
                    restored: 'The last saved settings were restored.',
                    connectionTestSuccess: 'LDAP connection test succeeded.',
                    recentTestSuccess: 'Last test succeeded: {0}',
                    recentTestFailed: 'Last test failed: {0}',
                    serverURLRequired: 'Enter the LDAP server URL.',
                    serverURLInvalid: 'Use a valid ldap:// or ldaps:// URL.',
                    userBaseDNRequired: 'Enter the User Base DN.',
                    bindDNRequired: 'Enter the Bind DN.',
                    passwordRequired: 'Enter the password.',
                    userFilterRequired: 'Enter the user filter.',
                    connectTimeoutRequired: 'Enter the connection timeout.',
                    searchPageSizeRequired: 'Enter the LDAP query page size.',
                    sync: {
                        title: 'Scheduled sync',
                        description:
                            'Read the full LDAP directory on a schedule and maintain imported LDAP users in 1Panel.',
                        enable: 'Enable schedule',
                        enableHelper:
                            'When disabled, automatic execution stops; manual synchronization remains available.',
                        schedule: 'Schedule',
                        daily: 'Daily',
                        weekly: 'Weekly',
                        ...
                        previewEmpty: 'No execution time available',
                        cronHelper: 'Use a standard five-field Cron expression: minute, hour, day, month, weekday.',
                        autoImport: 'Import new users',
                        autoImportHelper:
                            'When disabled, only directory identifiers and status are maintained for imported LDAP users; no new users are created.',
                        defaultRole: 'New user role',
                        ...
                        lastRunRunning: 'Sync started: {0}',
                        sourceDisabled: 'Enable and save AD/LDAP before running synchronization.',
                    ...
                    syncLogs: {
                        title: 'Sync logs',
                        description: 'Review scheduled and manual LDAP synchronization results.',
                        ...
                        running: 'Running',
                        result: 'Result',
                        resultSummary: 'Created {0}, updated {1}, missing {2}',
                        duration: 'Duration',
                        action: 'Action',
                    },
                    testLoginTitle: 'Test AD/LDAP login',
                    testLoginDesc:
                        'Bind with an AD/LDAP user credential to test authentication only. No 1Panel session is created.',
                    ldapUsername: 'LDAP username',
                    usernameRequired: 'Enter the LDAP username.',
                    startTest: 'Start test',
                    testLoginSuccess: 'Authentication succeeded.',
                    testLoginSuccessWithDN: 'Authentication succeeded. User DN: {0}',
                    import: {
                        title: 'Import AD/LDAP users',
                        source: 'Data source: AD/LDAP directory',
                        lastRead: 'Last read: {0}',
                        cacheHit: 'Cached result',
                        keywordPlaceholder: 'Search username',
                        search: 'Search',
                        refresh: 'Read from LDAP',
                        refreshTip: 'Ignore the short-term cache and read the LDAP directory again.',
                        loadFailed: 'Failed to read the LDAP directory.',
                        retry: 'Retry',
                        noData: 'No directory users found.',
                        username: 'Username',
                        status: 'Status',
                        changes: 'Changes',
                        ...
                        newUserRoleRequired: 'Select a role for new users.',
                        noNewUsers: 'There are no new users in this operation.',
                        roleOnlyForNewUsers: 'The selected role is applied only to newly created users.',
                        strictOff: 'Strict synchronization is disabled. A full import will not disable users.',
                        importSelected: 'Import/update selected ({0})',
                        importAll: 'Import/update all ({0})',
                        previewTitle: 'Confirm full import',
                        previewDesc:
                            'The complete LDAP directory was read. The search keyword does not limit this operation.',
                        created: 'Create',
                        updated: 'Update',
                        unchanged: 'Unchanged',
                        conflicts: 'Conflicts',
                        ...
                        reactivated: 'Reactivate',
                        strictWarning:
                            'Strict synchronization is enabled. Users missing from LDAP cannot sign in, but their records, roles, and permissions are retained.',
                        missingUsers: 'Users missing from LDAP',
                        missingScope: 'Only this LDAP source is affected.',
                        willDisable: 'Will be disabled',
                        confirmAll: 'Confirm import',
                        confirmAllWithMissing: 'Confirm import and disable {0} users',
                        executeSuccess: 'LDAP users were processed successfully.',
                        queryExpired: 'The directory result expired. Read from LDAP again.',
                        planIncomplete: 'The full directory read is incomplete and cannot be executed.',
                    },
                },
            },
        },
