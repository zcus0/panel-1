...
const message = {
    ...
    toolbox: {
        ...
        ftp: {
            ...
            initHelper:
                'La identidad de usuario FTP no está inicializada. Haz clic en Inicializar en la barra de estado superior.',
    ...
    license: {
        ...
        licenseRequiredUserTip:
            'La licencia OSS Edition no está vinculada. Contacte con un superadministrador para importar la licencia.',
    ...
    xpack: {
        ldap: {
            source: 'Origen',
            directoryMissing: 'No existe en LDAP',
            localCredentialsManaged:
                'El nombre de usuario y la contraseña se administran mediante LDAP y no pueden modificarse localmente.',
            sources: {
                local: 'Local',
                ldap: 'LDAP',
            },
            importUsers: 'Importar usuarios de AD/LDAP',
            searchUsersPlaceholder: 'Buscar nombre de usuario',
            readFromLDAP: 'Leer de LDAP',
            selectedUsers: '{0} seleccionados',
            queriedAt: 'Leído el',
            cachedResult: 'Resultado almacenado en caché',
            roleForNewUsers: 'Rol para nuevos usuarios',
            selectRole: 'Seleccione un rol',
            roleOnlyForNewUsers: 'Solo se requiere un rol cuando la importación crea usuarios.',
            roleRequiredForNewUsers: 'Seleccione un rol para los nuevos usuarios de LDAP.',
            changedFields: 'Campos modificados',
            importSelected: 'Importar seleccionado',
            importAll: 'Importar todo',
            importPreview: 'Vista previa de importación de AD/LDAP',
            importCompleted: 'Importación de AD/LDAP completada',
            incompletePreview: 'La lectura del directorio LDAP estuvo incompleta. Lea de LDAP nuevamente.',
            missingUsersWarning:
                'Los usuarios que falten en LDAP serán deshabilitados mediante sincronización estricta.',
            missingUsersWarningDetail: '{0} usuarios LDAP locales ya no podrán iniciar sesión.',
            action: 'Acción',
            reason: 'Razón',
            noImportChanges: 'Sin cambios de importación',
            confirmImport: 'Confirmar importación',
            created: 'Crear',
            updated: 'Actualizar',
            reactivated: 'Reactivar',
            unchanged: 'Sin cambios',
            conflicts: 'Conflictos',
            missing: 'Ausentes',
            missingUsersConfirm:
                '{0} usuarios ausentes en LDAP serán deshabilitados y se cerrarán sus sesiones. ¿Continuar?',
            strictSyncConfirm: 'Confirmar sincronización estricta',
            status: {
                importable: 'Nuevo usuario',
        ...
        expiresEnterpriseAlert:
            'Aviso: Tu licencia de OSS Edition expirará en {0} días y todas las funciones de OSS Edition dejarán de estar disponibles. Renueva pronto para asegurar el uso continuo.',
        expiresProAlert:
            'Aviso: Tu licencia de OSS Edition expirará en {0} días y todas las funciones de OSS Edition dejarán de estar disponibles. Renueva pronto para asegurar el uso continuo.',
        menu: 'Pro',
        ...
        user: {
            ...
            auth: {
                ...
                providerDescriptions: {
                    ldap: 'Compatible con Active Directory, OpenLDAP y otros servicios LDAP',
                    passkey: 'Utilice las credenciales del dispositivo para iniciar sesión sin contraseña',
                    radius: 'Autenticar el acceso a la red a través de un servicio Radius',
                    oidc: 'Conecte el inicio de sesión único empresarial con OpenID Connect',
                    saml2: 'Utilice SAML2 para la federación de identidades empresariales',
                    cas: 'Conecte un servicio de autenticación centralizado para inicio de sesión único',
                    oauth2: 'Conecte un servicio de identidad OAuth2 compatible',
                    dingtalk: 'Utilice la identidad de la organización DingTalk y el inicio de sesión QR',
                    feishu: 'Utilice la identidad de la organización Feishu y la sincronización de cuentas',
                    wecom: 'Autenticar con identidad de miembro de WeCom',
                },
                planned: 'Planificado',
                plannedTitle: 'Configuración de autenticación {0}',
                plannedDesc: 'Este proveedor de autenticación está planificado y aún no está disponible.',
                ldap: {
                    enable: 'Habilitar',
                    enabled: 'Habilitado',
                    disabled: 'Deshabilitado',
                    connection: 'Conexión básica',
                    connectionDesc:
                        'Configure el servicio de directorio y la cuenta de vinculación utilizada para buscar usuarios.',
                    serverURL: 'URL del servidor',
                    serverURLHelper: 'Admite URL ldap:// y ldaps://.',
                    userBaseDN: 'Base DN de usuario',
                    userBaseDNHelper:
                        'DN inicial para las búsquedas de usuarios LDAP; puede ser una OU, un CN o el DN raíz del dominio.',
                    bindDN: 'DN de enlace',
                    bindPassword: 'Contraseña',
                    passwordSaved: 'Déjelo en blanco para conservar la contraseña guardada.',
                    userSearch: 'Búsqueda de usuarios',
                    userSearchDesc:
                        'Configure la base y el filtro de búsqueda, y asigne el atributo LDAP al campo name de 1Panel.',
                    userFilter: 'Filtro de usuario',
                    userFilterTooltip:
                        'Reemplace %(user)s con el nombre de usuario con carácter de escape o con * para leer el directorio completo.',
                    userFilterHelper:
                        'Los nombres de usuario tienen caracteres de escape antes de insertarlos en el filtro LDAP.',
                    attributeMap: 'Mapeo de atributos',
                    attributeMapTooltip: 'Mapeo JSON del campo name de 1Panel a un atributo LDAP.',
                    attributeMapHelper: 'Configure el atributo LDAP asignado al campo name de 1Panel.',
                    ...
                    userImport: 'Importar usuarios',
                    saveBeforeImport: 'Guarde la configuración actual de AD/LDAP antes de importar usuarios.',
                    format: 'Formato',
                    restoreExample: 'Ejemplo de restauración',
                    mappingValid: 'JSON válido; el campo name está configurado.',
                    mappingInvalid: 'Introduzca un JSON válido.',
                    mappingObject: 'La asignación de atributos debe ser un objeto JSON.',
                    mappingOnlyName: 'Solo se admite la asignación name.',
                    mappingStringValues: 'Cada atributo asignado debe ser una cadena.',
                    mappingNameRequired: 'name debe ser una cadena que no esté vacía.',
                    restored: 'Se restauraron las últimas configuraciones guardadas.',
                    connectionTestSuccess: 'La prueba de conexión LDAP fue exitosa.',
                    recentTestSuccess: 'Última prueba exitosa: {0}',
                    recentTestFailed: 'Última prueba fallida: {0}',
                    serverURLRequired: 'Ingrese la URL del servidor LDAP.',
                    serverURLInvalid: 'Utilice una URL ldap:// o ldaps:// válida.',
                    userBaseDNRequired: 'Ingrese la Base DN de usuario.',
                    ...
                    connectTimeoutRequired: 'Introduzca el tiempo de espera de la conexión.',
                    searchPageSizeRequired: 'Ingrese el tamaño de la página de consulta LDAP.',
                    sync: {
                        title: 'Sincronización programada',
                        description:
                            'Lea el directorio LDAP completo de forma programada y mantenga los usuarios LDAP importados en 1Panel.',
                        enable: 'Habilitar horario',
                        enableHelper:
                            'Cuando está deshabilitado, la ejecución automática se detiene; la sincronización manual permanece disponible.',
                        schedule: 'Horario',
                        daily: 'Diariamente',
                        weekly: 'Semanal',
                        customCron: 'Personalizado Cron',
                        preview: 'Vista previa',
                        previewTitle: 'Próximas 5 ejecuciones',
                        previewEmpty: 'No hay tiempo de ejecución disponible',
                        cronHelper:
                            'Utilice una expresión Cron estándar de cinco campos: minuto, hora, día, mes y día de la semana.',
                        autoImport: 'Importar nuevos usuarios',
                        autoImportHelper:
                            'Cuando está deshabilitado, solo se mantienen los identificadores y el estado del directorio para los usuarios LDAP importados; no se crean nuevos usuarios.',
                        defaultRole: 'Nuevo rol de usuario',
                        ...
                        lastRunRunning: 'Sincronización iniciada: {0}',
                        sourceDisabled: 'Habilite y guarde AD/LDAP antes de ejecutar la sincronización.',
                        cronRequired: 'Introduzca una expresión Cron.',
                    ...
                    syncLogs: {
                        ...
                        description: 'Revise los resultados de la sincronización manual y programada de LDAP.',
                        ...
                        running: 'En ejecución',
                        result: 'Resultado',
                        resultSummary: 'Creados {0}, actualizados {1}, ausentes {2}',
                        duration: 'Duración',
                        action: 'acción',
                    },
                    testLoginTitle: 'Probar inicio de sesión AD/LDAP',
                    testLoginDesc:
                        'Vincule con una credencial de usuario AD/LDAP para probar solo la autenticación. No se crea ninguna sesión 1Panel.',
                    ldapUsername: 'nombre de usuario LDAP',
                    usernameRequired: 'Ingrese el nombre de usuario LDAP.',
                    startTest: 'Iniciar prueba',
                    testLoginSuccess: 'La autenticación fue exitosa.',
                    testLoginSuccessWithDN: 'La autenticación fue exitosa. Usuario DN: {0}',
                    import: {
                        title: 'Importar usuarios de AD/LDAP',
                        source: 'Fuente de datos: directorio AD/LDAP',
                        lastRead: 'Última lectura: {0}',
                        cacheHit: 'Resultado almacenado en caché',
                        keywordPlaceholder: 'Buscar nombre de usuario',
                        search: 'Buscar',
                        refresh: 'Leer de LDAP',
                        refreshTip: 'Ignore el caché a corto plazo y vuelva a leer el directorio LDAP.',
                        loadFailed: 'No se pudo leer el directorio LDAP.',
                        retry: 'Reintentar',
                        noData: 'No se encontraron usuarios del directorio.',
                        ...
                        conflict: 'Conflicto de nombres',
                        selectedCount: '{0} seleccionado',
                        totalCount: '{0} usuarios',
                        newUserRole: 'Nuevo rol de usuario',
                        newUserRoleRequired: 'Seleccione un rol para nuevos usuarios.',
                        noNewUsers: 'No hay nuevos usuarios en esta operación.',
                        roleOnlyForNewUsers: 'El rol seleccionado se aplica solo a los usuarios recién creados.',
                        strictOff:
                            'La sincronización estricta está deshabilitada. Una importación completa no deshabilitará a los usuarios.',
                        importSelected: 'Importar/actualizar seleccionado ({0})',
                        importAll: 'Importar/actualizar todo ({0})',
                        previewTitle: 'Confirmar importación completa',
                        previewDesc:
                            'Se leyó el directorio LDAP completo. La palabra clave de búsqueda no limita esta operación.',
                        created: 'crear',
                        updated: 'Actualizar',
                        unchanged: 'Sin cambios',
                        conflicts: 'Conflictos',
                        ...
                        reactivated: 'Reactivar',
                        strictWarning:
                            'La sincronización estricta está habilitada. Los usuarios que faltan en LDAP no pueden iniciar sesión, pero se conservan sus registros, roles y permisos.',
                        missingUsers: 'Usuarios que faltan en LDAP',
                        missingScope: 'Sólo esta fuente LDAP se ve afectada.',
                        willDisable: 'Estará deshabilitado',
                        confirmAll: 'Confirmar importación',
                        confirmAllWithMissing: 'Confirmar importación y deshabilitar {0} usuarios',
                        executeSuccess: 'Los usuarios de LDAP se procesaron exitosamente.',
                        queryExpired: 'El resultado del directorio expiró. Lea de LDAP nuevamente.',
                        planIncomplete: 'La lectura completa del directorio está incompleta y no se puede ejecutar.',
                    },
                },
            },
        },
