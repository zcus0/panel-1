...
const message = {
    ...
    xpack: {
        ldap: {
            source: 'Kaynak',
            directoryMissing: "LDAP'te bulunamadı",
            localCredentialsManaged:
                'Kullanıcı adı ve parola LDAP tarafından yönetilir ve yerel olarak değiştirilemez.',
            sources: {
                local: 'Yerel',
                ldap: 'LDAP',
            },
            importUsers: 'AD/LDAP kullanıcılarını içe aktar',
            searchUsersPlaceholder: 'Kullanıcı adını ara',
            readFromLDAP: "LDAP'dan okuyun",
            selectedUsers: '{0} seçildi',
            queriedAt: 'Okuma zamanı',
            cachedResult: 'Önbelleğe alınmış sonuç',
            roleForNewUsers: 'Yeni kullanıcılar için rol',
            selectRole: 'Bir rol seçin',
            roleOnlyForNewUsers: 'Bir rol yalnızca içe aktarma işleminde kullanıcılar oluşturduğunda gereklidir.',
            roleRequiredForNewUsers: 'Yeni LDAP kullanıcıları için bir rol seçin.',
            changedFields: 'Değiştirilen alanlar',
            importSelected: 'Seçileni içe aktar',
            importAll: 'Tümünü içe aktar',
            importPreview: 'AD/LDAP içe aktarma önizlemesi',
            importCompleted: 'AD/LDAP içe aktarma tamamlandı',
            incompletePreview: "LDAP dizin okuması tamamlanmadı. LDAP'dan tekrar okuyun.",
            missingUsersWarning: "LDAP'da eksik olan kullanıcılar katı senkronizasyonla devre dışı bırakılacak.",
            missingUsersWarningDetail: '{0} yerel LDAP kullanıcıları artık oturum açamayacak.',
            action: 'Eylem',
            reason: 'Sebep',
            noImportChanges: 'İçe aktarma değişikliği yok',
            confirmImport: 'İçe aktarmayı onayla',
            created: 'Oluştur',
            updated: 'Güncelleme',
            reactivated: 'Yeniden etkinleştir',
            unchanged: 'değişmedi',
            conflicts: 'Çatışmalar',
            missing: 'Eksik',
            missingUsersConfirm:
                "LDAP'da bulunmayan {0} kullanıcı devre dışı bırakılacak ve oturumları kapatılacak. Devam edilsin mi?",
            strictSyncConfirm: 'Kesin senkronizasyonu onaylayın',
            status: {
                importable: 'Yeni kullanıcı',
            ...
            fields: {
                ...
                authSourceStatus: 'Kimlik doğrulama durumu',
            },
            actions: {
                created: 'Oluştur',
                updated: 'Güncelleme',
        ...
        user: {
            ...
            auth: {
                ...
                providerDescriptions: {
                    ldap: 'Active Directory, OpenLDAP ve diğer LDAP hizmetleriyle uyumludur',
                    passkey: 'Parolasız oturum açmak için cihaz kimlik bilgilerini kullanın',
                    radius: 'Radius hizmeti aracılığıyla ağ erişimini doğrulayın',
                    oidc: 'Kurumsal çoklu oturum açmayı OpenID Connect ile bağlayın',
                    saml2: "Kurumsal kimlik federasyonu için SAML2'yi kullanın",
                    cas: 'Tek oturum açma için merkezi bir kimlik doğrulama hizmetine bağlanın',
                    oauth2: 'Uyumlu bir OAuth2 kimlik hizmetine bağlanın',
                    dingtalk: 'DingTalk kuruluş kimliğini ve QR ile oturum açmayı kullanın',
                    feishu: 'Feishu kuruluş kimliğini ve hesap senkronizasyonunu kullanma',
                    wecom: 'WeCom üye kimliğiyle kimlik doğrulama',
                },
                planned: 'Planlanan',
                plannedTitle: '{0} kimlik doğrulama ayarları',
                plannedDesc: 'Bu kimlik doğrulama sağlayıcısı planlanmıştır ve henüz kullanılamamaktadır.',
                ldap: {
                    enable: 'Etkinleştir',
                    enabled: 'Etkin',
                    disabled: 'Devre dışı',
                    connection: 'Temel bağlantı',
                    connectionDesc:
                        'Kullanıcıları aramak için kullanılan dizin hizmetini ve bağlama hesabını yapılandırın.',
                    serverURL: "Sunucu URL'si",
                    serverURLHelper: "ldap:// ve ldaps:// URL'lerini destekler.",
                    userBaseDN: 'Kullanıcı Base DN',
                    userBaseDNHelper:
                        "LDAP kullanıcı aramaları için DN'nun başlatılması; bu bir OU, CN veya etki alanı kökü DN olabilir.",
                    bindDN: "DN'yu bağla",
                    bindPassword: 'Şifre',
                    ...
                    restore: 'Geri yükle',
                    testConnection: 'Bağlantıyı test edin',
                    testLogin: 'Oturum açmayı test edin',
                    userImport: 'Kullanıcıları içe aktar',
                    saveBeforeImport: 'Kullanıcıları içe aktarmadan önce mevcut AD/LDAP ayarlarını kaydedin.',
                    format: 'Biçim',
                    restoreExample: 'Örneği geri yükle',
                    mappingValid: 'Geçerli JSON; name yapılandırıldı.',
                    mappingInvalid: 'Geçerli JSON girin.',
                    mappingObject: 'Öznitelik eşlemesi bir JSON nesnesi olmalıdır.',
                    mappingOnlyName: 'Yalnızca name eşlemesi desteklenir.',
                    mappingStringValues: 'Her eşlenen öznitelik bir dize olmalıdır.',
                    mappingNameRequired: 'name boş olmayan bir dize olmalıdır.',
                    restored: 'Son kaydedilen ayarlar geri yüklendi.',
                    connectionTestSuccess: 'LDAP bağlantı testi başarılı oldu.',
                    recentTestSuccess: 'Son test başarılı oldu: {0}',
                    recentTestFailed: 'Son test başarısız oldu: {0}',
                    serverURLRequired: "LDAP sunucu URL'sini girin.",
                    serverURLInvalid: "Geçerli bir ldap:// veya ldaps:// URL'si kullanın.",
                    userBaseDNRequired: 'Base DN Kullanıcısını girin.',
                    bindDNRequired: 'DN bağlamasını girin.',
                    passwordRequired: 'Şifreyi girin.',
                    userFilterRequired: 'Kullanıcı filtresini girin.',
                    connectTimeoutRequired: 'Bağlantı zaman aşımını girin.',
                    searchPageSizeRequired: 'LDAP sorgu sayfası boyutunu girin.',
                    sync: {
                        ...
                        preview: 'Önizleme',
                        previewTitle: 'Sonraki 5 çalıştırma',
                        previewEmpty: 'Yürütme süresi yok',
                        cronHelper:
                            'Standart beş alanlı Cron ifadesini kullanın: dakika, saat, gün, ay, haftanın günü.',
                        autoImport: 'Yeni kullanıcıları içe aktar',
                        autoImportHelper:
                            'Devre dışı bırakıldığında, içe aktarılan LDAP kullanıcıları için yalnızca dizin tanımlayıcıları ve durumu korunur; yeni kullanıcı oluşturulmaz.',
                        defaultRole: 'Yeni kullanıcı rolü',
                        ...
                        lastRunRunning: 'Senkronizasyon başladı: {0}',
                        sourceDisabled: "Senkronizasyonu çalıştırmadan önce AD/LDAP'yu etkinleştirin ve kaydedin.",
                        cronRequired: 'Bir Cron ifadesi girin.',
                    ...
                    syncLogs: {
                        title: 'Günlükleri senkronize et',
                        description: 'Planlanmış ve manuel LDAP senkronizasyon sonuçlarını inceleyin.',
                        startedAt: 'Başlangıç zamanı',
                        trigger: 'Çalıştırma türü',
                        manual: 'Manuel',
                        ...
                        running: 'Çalışıyor',
                        result: 'Sonuç',
                        resultSummary: '{0} oluşturuldu, {1} güncellendi, {2} eksik',
                        duration: 'Süre',
                        action: 'Eylem',
                    },
                    ...
                    testLoginSuccess: 'Kimlik doğrulama başarılı oldu.',
                    testLoginSuccessWithDN: 'Kimlik doğrulama başarılı oldu. Kullanıcı DN: {0}',
                    import: {
                        title: 'AD/LDAP kullanıcılarını içe aktar',
                        source: 'Veri kaynağı: AD/LDAP dizini',
                        lastRead: 'Son okuma: {0}',
                        cacheHit: 'Önbelleğe alınmış sonuç',
                        keywordPlaceholder: 'Kullanıcı adını ara',
                        search: 'Ara',
                        refresh: "LDAP'dan okuyun",
                        refreshTip: 'Kısa süreli önbelleği göz ardı edin ve LDAP dizinini yeniden okuyun.',
                        loadFailed: 'LDAP dizini okunamadı.',
                        retry: 'Yeniden dene',
                        noData: 'Hiçbir dizin kullanıcısı bulunamadı.',
                        username: 'Kullanıcı adı',
                        status: 'Durum',
                        changes: 'Değişiklikler',
                        noChanges: 'Değişiklik yok',
                        importable: 'İçe aktarmaya hazır',
                        updateAvailable: 'Güncelleme mevcut',
                        upToDate: 'güncel',
                        conflict: 'Ad çakışması',
                        selectedCount: '{0} seçildi',
                        totalCount: '{0} kullanıcı',
                        newUserRole: 'Yeni kullanıcı rolü',
                        newUserRoleRequired: 'Yeni kullanıcılar için bir rol seçin.',
                        noNewUsers: 'Bu operasyonda yeni kullanıcı yok.',
                        roleOnlyForNewUsers: 'Seçilen rol yalnızca yeni oluşturulan kullanıcılara uygulanır.',
                        strictOff:
                            'Katı senkronizasyon devre dışı bırakıldı. Tam içe aktarma, kullanıcıları devre dışı bırakmaz.',
                        importSelected: 'İçe aktarma/güncelleme seçildi ({0})',
                        importAll: 'Tümünü içe aktar/güncelle ({0})',
                        previewTitle: 'Tam içe aktarmayı onaylayın',
                        previewDesc: 'LDAP dizininin tamamı okundu. Arama anahtar sözcüğü bu işlemi sınırlamaz.',
                        created: 'Oluştur',
                        updated: 'Güncelleme',
                        unchanged: 'değişmedi',
                        conflicts: 'Çatışmalar',
                        ...
                        reactivated: 'Yeniden etkinleştir',
                        strictWarning:
                            "Katı senkronizasyon etkinleştirildi. LDAP'da bulunmayan kullanıcılar oturum açamaz ancak kayıtları, rolleri ve izinleri korunur.",
                        missingUsers: "LDAP'da eksik olan kullanıcılar",
                        missingScope: 'Yalnızca bu LDAP kaynağı etkilenir.',
                        willDisable: 'Devre dışı bırakılacak',
                        confirmAll: 'İçe aktarmayı onayla',
                        confirmAllWithMissing: 'İçe aktarmayı onayla ve {0} kullanıcıyı devre dışı bırak',
                        executeSuccess: 'LDAP kullanıcıları başarıyla işlendi.',
                        queryExpired: "Dizin sonucunun süresi doldu. LDAP'dan tekrar okuyun.",
                        planIncomplete: 'Tam dizin okuması tamamlanmadı ve yürütülemiyor.',
                    },
                },
            },
        },
