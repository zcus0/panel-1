...
const message = {
    ...
    aiTools: {
        agents: {
            ...
            discoverModelsFailedUseDefaults: 'モデルを取得できませんでした。デフォルトモデルを使用しています。',
            ...
            customImageURLHelper:
                'Custom アカウントには画像生成 API の完全な URL を入力してください。パスは自動追加されません。例: {0}',
            apiTypeBaseURLMismatch: '現在の Base URL は {0} のパスに見えますが、{1} が選択されています。推奨 URL: {2}',
            validateAvailability: 'アカウントの可用性を検証',
            validateAvailabilityHelper: '保存前に最小メッセージを送信して API を検証します',
            validateImageAvailabilityHelper: '保存前に最小画像を1枚生成するため、料金が発生する場合があります',
        },
        model: {
            model: 'モデル',
            localModel: 'ローカルモデル',
    ...
    toolbox: {
        ...
        ftp: {
            ...
            initHelper:
                'FTP ユーザー ID が初期化されていません。上部のステータスバーにある「初期化」をクリックしてください。',
    ...
    xpack: {
        ldap: {
            source: 'ソース',
            directoryMissing: 'LDAP に存在しません',
            localCredentialsManaged:
                'このユーザーのユーザー名とパスワードは LDAP で管理されているため、ローカルでは変更できません。',
            sources: {
                local: 'ローカル',
                ldap: 'LDAP',
            },
            importUsers: 'AD/LDAP ユーザーをインポート',
            searchUsersPlaceholder: 'ユーザー名を検索',
            readFromLDAP: 'LDAP から読み取る',
            selectedUsers: '{0} が選択されました',
            queriedAt: '読み取り時刻',
            cachedResult: 'キャッシュされた結果',
            roleForNewUsers: '新規ユーザーの役割',
            selectRole: '役割を選択してください',
            roleOnlyForNewUsers: 'ロールは、インポートによってユーザーが作成される場合にのみ必要です。',
            roleRequiredForNewUsers: '新しい LDAP ユーザーのロールを選択します。',
            changedFields: '変更されたフィールド',
            importSelected: '選択したインポート',
            importAll: 'すべてインポート',
            importPreview: 'AD/LDAP インポートプレビュー',
            importCompleted: 'AD/LDAP インポート完了',
            incompletePreview: 'LDAP ディレクトリの読み取りが不完全でした。再び LDAP から読み取ります。',
            missingUsersWarning: 'LDAP にないユーザーは、厳密な同期によって無効になります。',
            missingUsersWarningDetail: 'ローカル LDAP ユーザー {0} 人がサインインできなくなります。',
            action: 'アクション',
            reason: '理由',
            noImportChanges: 'インポートの変更はありません',
            ...
            conflicts: '競合',
            missing: '欠落',
            missingUsersConfirm: 'LDAP に存在しない {0} 人のユーザーを無効化し、セッションを終了します。続行しますか？',
            strictSyncConfirm: '厳密な同期を確認する',
            status: {
                importable: '新規ユーザー',
            ...
            fields: {
                name: 'ユーザー名',
                externalDN: 'ディレクトリ DN',
                externalID: '外部ID',
                authSourceStatus: '認証状態',
            },
            actions: {
                created: '作成',
                updated: '更新',
        ...
        user: {
            ...
            auth: {
                ...
                providerDescriptions: {
                    ldap: 'Active Directory、OpenLDAP、およびその他の LDAP サービスと互換性があります',
                    passkey: 'パスワードなしのサインインにデバイス資格情報を使用する',
                    radius: 'Radius サービスを介したネットワーク アクセスの認証',
                    oidc: 'OpenID Connect を使用してエンタープライズ シングル サインオンを接続する',
                    saml2: 'エンタープライズ ID フェデレーションに SAML2 を使用する',
                    cas: 'シングル サインオンのための集中認証サービスに接続する',
                    oauth2: '互換性のある OAuth2 ID サービスに接続する',
                    dingtalk: 'DingTalk 組織 ID と QR サインインを使用する',
                    feishu: 'Feishu 組織 ID とアカウント同期を使用する',
                    wecom: 'WeCom メンバー ID で認証する',
                },
                planned: '計画済み',
                plannedTitle: '{0} 認証設定',
                plannedDesc: 'この認証プロバイダーは計画されており、まだ利用できません。',
                ldap: {
                    enable: '有効にする',
                    enabled: '有効',
                    disabled: '無効',
                    connection: '基本接続',
                    connectionDesc: 'ユーザーの検索に使用するディレクトリ サービスとバインド アカウントを構成します。',
                    serverURL: 'サーバーURL',
                    serverURLHelper: 'ldap:// および ldaps:// URL をサポートします。',
                    userBaseDN: 'ユーザー Base DN',
                    userBaseDNHelper:
                        'LDAP ユーザー検索のために DN を開始します。 OU、CN、またはドメイン ルート DN にすることができます。',
                    bindDN: 'バインド DN',
                    bindPassword: 'パスワード',
                    ...
                    testLogin: 'ログインテスト',
                    userImport: 'ユーザーをインポートする',
                    saveBeforeImport: 'ユーザーをインポートする前に、現在の AD/LDAP 設定を保存します。',
                    format: 'フォーマット',
                    restoreExample: '復元の例',
                    mappingValid: '有効なJSON; name が設定されています。',
                    mappingInvalid: '有効な JSON を入力してください。',
                    mappingObject: '属性マッピングは JSON オブジェクトである必要があります。',
                    mappingOnlyName: 'name マッピングのみがサポートされます。',
                    mappingStringValues: 'マッピングされたすべての属性は文字列である必要があります。',
                    mappingNameRequired: 'name は空ではない文字列である必要があります。',
                    restored: '最後に保存された設定が復元されました。',
                    connectionTestSuccess: 'LDAP 接続テストに成功しました。',
                    recentTestSuccess: '最後のテストが成功しました: {0}',
                    recentTestFailed: '最後のテストが失敗しました: {0}',
                    serverURLRequired: 'LDAP サーバーの URL を入力します。',
                    serverURLInvalid: '有効な ldap:// または ldaps:// URL を使用してください。',
                    userBaseDNRequired: 'ユーザー Base DN を入力します。',
                    bindDNRequired: 'バインド DN を入力してください。',
                    passwordRequired: 'パスワードを入力します。',
                    userFilterRequired: 'ユーザーフィルターを入力します。',
                    connectTimeoutRequired: '接続タイムアウトを入力します。',
                    searchPageSizeRequired: 'LDAP クエリのページ サイズを入力します。',
                    sync: {
                        title: 'スケジュールされた同期',
                        description:
                        ...
                        customCron: 'カスタムCron',
                        preview: 'プレビュー',
                        previewTitle: '次の 5 回の実行',
                        previewEmpty: '利用可能な実行時間がありません',
                        cronHelper: '標準の 5 フィールド Cron 式 (分、時、日、月、曜日) を使用します。',
                        autoImport: '新しいユーザーをインポートする',
                        autoImportHelper:
                            '無効にすると、インポートされた LDAP ユーザーのディレクトリ識別子とステータスのみが維持されます。新しいユーザーは作成されません。',
                        defaultRole: '新しいユーザーの役割',
                        defaultRolePlaceholder: '役割を選択してください',
                        ...
                        lastRunRunning: '同期が開始されました: {0}',
                        sourceDisabled: '同期を実行する前に、AD/LDAP を有効にして保存します。',
                        cronRequired: 'Cron 式を入力します。',
                    ...
                    syncLogs: {
                        title: 'ログを同期する',
                        description: 'スケジュールされたおよび手動の LDAP 同期結果を確認します。',
                        startedAt: '開始時間',
                        trigger: '実行方式',
                        manual: '手動',
                        scheduled: '予定されている',
                    ...
                    startTest: 'テストの開始',
                    testLoginSuccess: '認証に成功しました。',
                    testLoginSuccessWithDN: '認証に成功しました。ユーザー DN: {0}',
                    import: {
                        title: 'AD/LDAP ユーザーをインポート',
                        source: 'データソース: AD/LDAP ディレクトリ',
                        lastRead: '最終読み取り: {0}',
                        cacheHit: 'キャッシュされた結果',
                        keywordPlaceholder: 'ユーザー名を検索',
                        search: '検索',
                        refresh: 'LDAP から読み取る',
                        refreshTip: '短期キャッシュを無視して、LDAP ディレクトリを再度読み取ります。',
                        loadFailed: 'LDAP ディレクトリの読み取りに失敗しました。',
                        retry: '再試行',
                        noData: 'ディレクトリ ユーザーが見つかりません。',
                        username: 'ユーザー名',
                        status: 'ステータス',
                        changes: '変更点',
                        noChanges: '変更なし',
                        importable: 'インポートの準備ができました',
                        updateAvailable: '利用可能なアップデート',
                        upToDate: '最新の状態',
                        conflict: '名前の競合',
                        selectedCount: '{0} が選択されました',
                        totalCount: '{0} 人のユーザー',
                        newUserRole: '新しいユーザーの役割',
                        newUserRoleRequired: '新しいユーザーの役割を選択します。',
                        noNewUsers: 'この操作には新規ユーザーはいません。',
                        roleOnlyForNewUsers: '選択したロールは、新しく作成されたユーザーにのみ適用されます。',
                        strictOff: '厳密な同期は無効になっています。完全インポートではユーザーは無効になりません。',
                        importSelected: '選択されたインポート/更新 ({0})',
                        importAll: 'すべてインポート/更新 ({0})',
                        previewTitle: '完全なインポートを確認する',
                        previewDesc:
                            '完全な LDAP ディレクトリが読み取られました。検索キーワードによる制限はありません。',
                        created: '作成',
                        updated: 'アップデート',
                        unchanged: '変わらない',
                        conflicts: '紛争',
                        ...
                        reactivated: '再アクティブ化',
                        strictWarning:
                            '厳密な同期が有効になっています。 LDAP にいないユーザーはサインインできませんが、レコード、ロール、権限は保持されます。',
                        missingUsers: 'LDAP からユーザーが欠落しています',
                        missingScope: 'この LDAP ソースのみが影響を受けます。',
                        willDisable: '無効になります',
                        confirmAll: 'インポートの確認',
                        confirmAllWithMissing: 'インポートを確認し、{0} 人のユーザーを無効化する',
                        executeSuccess: 'LDAP ユーザーは正常に処理されました。',
                        queryExpired: 'ディレクトリ結果の有効期限が切れました。再び LDAP から読み取ります。',
                        planIncomplete: 'ディレクトリ全体の読み取りは不完全であるため、実行できません。',
                    },
                },
            },
        },
