...
const message = {
    ...
    toolbox: {
        ...
        ftp: {
            ...
            initHelper:
                'Идентификатор пользователя FTP не инициализирован. Сначала нажмите «Инициализировать» в верхней строке состояния.',
    ...
    license: {
        ...
        licenseAlert:
            'Узлы можно добавлять только при правильной привязке лицензии к узлу. Переключение поддерживается только для узлов, правильно привязанных к лицензии.',
        licenseUnbindHelper:
            'Обнаружены узлы для этой лицензии. Отвяжите лицензию и повторите попытку!',
        ...
        licenseRequiredUserTip:
            'Лицензия OSS Edition не привязана. Обратитесь к суперадминистратору для импорта лицензии.',
    ...
    xpack: {
        ldap: {
            source: 'Источник',
            directoryMissing: 'Отсутствует в LDAP',
            localCredentialsManaged: 'Имя пользователя и пароль управляются LDAP и не могут быть изменены локально.',
            sources: {
                local: 'Локальный',
                ldap: 'LDAP',
            },
            importUsers: 'Импорт пользователей AD/LDAP',
            searchUsersPlaceholder: 'Поиск имени пользователя',
            readFromLDAP: 'Читать из LDAP',
            selectedUsers: '{0} выбрано',
            queriedAt: 'Время чтения',
            cachedResult: 'Кэшированный результат',
            roleForNewUsers: 'Роль для новых пользователей',
            selectRole: 'Выберите роль',
            roleOnlyForNewUsers: 'Роль требуется только тогда, когда при импорте создаются пользователи.',
            roleRequiredForNewUsers: 'Выберите роль для новых пользователей LDAP.',
            changedFields: 'Измененные поля',
            importSelected: 'Импортировать выбранное',
            importAll: 'Импортировать все',
            importPreview: 'Предпросмотр импорта AD/LDAP',
            importCompleted: 'Импорт AD/LDAP завершён',
            incompletePreview: 'Чтение каталога LDAP было неполным. Прочтите еще раз LDAP.',
            missingUsersWarning:
                'Пользователи, отсутствующие в LDAP, будут отключены посредством строгой синхронизации.',
            missingUsersWarningDetail: '{0} локальных пользователей LDAP больше не смогут войти в систему.',
            action: 'Действие',
            reason: 'Причина',
            noImportChanges: 'Никаких изменений импорта',
            confirmImport: 'Подтвердить импорт',
            created: 'Создать',
            updated: 'Обновить',
            reactivated: 'Повторно активировать',
            unchanged: 'Без изменений',
            conflicts: 'Конфликты',
            missing: 'Отсутствует',
            missingUsersConfirm:
                '{0} пользователей, отсутствующих в LDAP, будут отключены, а их сеансы завершены. Продолжить?',
            strictSyncConfirm: 'Подтвердить строгую синхронизацию',
            status: {
                importable: 'Новый пользователь',
            ...
            fields: {
                ...
                externalDN: 'Каталог DN',
                externalID: 'Внешний идентификатор',
                authSourceStatus: 'Статус аутентификации',
            },
            actions: {
                created: 'Создать',
                updated: 'Обновить',
        ...
        expiresEnterpriseAlert:
            'Дружеское напоминание: ваша лицензия OSS Edition истечет через {0} дней, и все функции OSS Edition станут недоступны. Пожалуйста, продлите лицензию вовремя, чтобы обеспечить дальнейшее использование.',
        expiresProAlert:
            'Дружеское напоминание: ваша лицензия OSS Edition истечет через {0} дней, и все функции OSS Edition станут недоступны. Пожалуйста, продлите лицензию вовремя, чтобы обеспечить дальнейшее использование.',
        menu: 'Рro',
        ...
        user: {
            ...
            view: 'Просмотр',
            manage: 'Управление',
            authManage: 'Управление аутентификацией',
            auth: {
                providerNavigation: 'Поставщики аутентификации',
                providers: {
                    ldap: 'AD/LDAP',
                    passkey: 'Passkey',
                    radius: 'Radius',
                ...
                providerDescriptions: {
                    ldap: 'Совместимость с Active Directory, OpenLDAP и другими службами LDAP.',
                    passkey: 'Используйте учетные данные устройства для входа без пароля',
                    radius: 'Аутентификация доступа к сети через службу Radius',
                    oidc: 'Подключите корпоративный единый вход с помощью OpenID Connect',
                    saml2: 'Используйте SAML2 для федерации корпоративных удостоверений.',
                    cas: 'Подключите централизованную службу аутентификации для единого входа',
                    oauth2: 'Подключите совместимую службу идентификации OAuth2.',
                    dingtalk: 'Используйте идентификатор организации DingTalk и вход с помощью QR',
                    feishu: 'Используйте идентификацию организации Feishu и синхронизацию учетных записей.',
                    wecom: 'Аутентификация с использованием удостоверения участника WeCom',
                },
                planned: 'Планируется',
                plannedTitle: 'Настройки аутентификации {0}',
                plannedDesc: 'Этот поставщик аутентификации запланирован и пока недоступен.',
                ldap: {
                    enable: 'Включить',
                    enabled: 'Включено',
                    disabled: 'Отключено',
                    connection: 'Базовое подключение',
                    connectionDesc:
                        'Настройте службу каталогов и учетную запись привязки, используемую для поиска пользователей.',
                    serverURL: 'URL-адрес сервера',
                    serverURLHelper: 'Поддерживает URL-адреса ldap:// и ldaps://.',
                    userBaseDN: 'Пользователь Base DN',
                    userBaseDNHelper:
                        'Запуск DN для поиска пользователей LDAP; это может быть OU, CN или корень домена DN.',
                    bindDN: 'Привязать DN',
                    bindPassword: 'Пароль',
                    passwordSaved: 'Оставьте поле пустым, чтобы сохранить сохраненный пароль.',
                    userSearch: 'Поиск пользователей',
                    userSearchDesc:
                        'Установите базу поиска пользователей и фильтр, затем сопоставьте атрибут LDAP, используемый как 1Panel name.',
                    userFilter: 'Пользовательский фильтр',
                    userFilterTooltip:
                        'Замените %(user)s экранированным именем пользователя или на * для полного чтения каталога.',
                    userFilterHelper: 'Имена пользователей экранируются перед вставкой в ​​фильтр LDAP.',
                    attributeMap: 'Сопоставление атрибутов',
                    attributeMapTooltip: 'Сопоставление JSON поля 1Panel name с атрибутом LDAP.',
                    attributeMapHelper: 'Установите атрибут LDAP, сопоставленный с полем 1Panel name.',
                    advanced: 'Расширенные настройки',
                    advancedDesc: 'Настройте разбиение запросов TLS и LDAP.',
                    strictSync: 'Строгая синхронизация',
                    strictSyncTooltip:
                        'После полного импорта пользователи, отсутствующие в этом источнике LDAP, отключаются, но не удаляются.',
                    strictSyncHelper:
                        'Применяется только к полному импорту. Импорт выбранных пользователей никогда не отключает других пользователей.',
                    skipTLSVerify: 'Пропустить проверку TLS',
                    skipTLSVerifyTooltip: 'Отключите проверку сертификата для соединений LDAPS.',
                    skipTLSVerifyHelper:
                        'Используйте только с доверенным самозаверяющим сертификатом. Этот параметр не зависит от строгой синхронизации.',
                    connectTimeout: 'Таймаут соединения (секунды)',
                    searchPageSize: 'Размер страницы запроса LDAP',
                    restore: 'Восстановить',
                    testConnection: 'Тестовое соединение',
                    testLogin: 'Тестовый вход',
                    userImport: 'Импортировать пользователей',
                    saveBeforeImport: 'Сохраните текущие настройки AD/LDAP перед импортом пользователей.',
                    format: 'Формат',
                    restoreExample: 'Пример восстановления',
                    mappingValid: 'Действителен JSON; name настроен.',
                    mappingInvalid: 'Введите действительный JSON.',
                    mappingObject: 'Сопоставление атрибутов должно быть объектом JSON.',
                    mappingOnlyName: 'Поддерживается только сопоставление name.',
                    mappingStringValues: 'Каждый сопоставленный атрибут должен быть строкой.',
                    mappingNameRequired: 'name должен быть непустой строкой.',
                    restored: 'Последние сохраненные настройки были восстановлены.',
                    connectionTestSuccess: 'Проверка соединения LDAP прошла успешно.',
                    recentTestSuccess: 'Последний тест прошел успешно: {0}',
                    recentTestFailed: 'Последний тест не пройден: {0}',
                    serverURLRequired: 'Введите URL-адрес сервера LDAP.',
                    serverURLInvalid: 'Используйте действительный URL-адрес ldap:// или ldaps://.',
                    userBaseDNRequired: 'Введите пользователя Base DN.',
                    bindDNRequired: 'Введите привязку DN.',
                    passwordRequired: 'Введите пароль.',
                    userFilterRequired: 'Введите фильтр пользователей.',
                    connectTimeoutRequired: 'Введите тайм-аут соединения.',
                    searchPageSizeRequired: 'Введите размер страницы запроса LDAP.',
                    sync: {
                        title: 'Запланированная синхронизация',
                        description:
                            'Чтение полного каталога LDAP по расписанию и поддержка импортированных пользователей LDAP в 1Panel.',
                        enable: 'Включить расписание',
                        enableHelper:
                            'При отключении автоматическое выполнение останавливается; ручная синхронизация остается доступной.',
                        schedule: 'Расписание',
                        daily: 'Ежедневно',
                        weekly: 'Еженедельно',
                        ...
                        previewEmpty: 'Нет времени выполнения',
                        cronHelper:
                            'Используйте стандартное выражение Cron из пяти полей: минуты, часы, день, месяц, день недели.',
                        autoImport: 'Импортировать новых пользователей',
                        autoImportHelper:
                            'Если этот параметр отключен, для импортированных пользователей LDAP сохраняются только идентификаторы каталогов и статус; новые пользователи не создаются.',
                        defaultRole: 'Новая роль пользователя',
                        defaultRolePlaceholder: 'Выберите роль',
                        defaultRoleHelper:
                            'Применяется только к пользователям, созданным с помощью запланированной синхронизации.',
                        defaultRoleRequired: 'Выберите роль для новых пользователей LDAP.',
                        strictSyncHelper:
                            'Пользователи, отсутствующие в полном запросе, отключаются, а их сеансы очищаются; пользователи, роли и разрешения не удаляются.',
                        safetyTitle: 'Отсутствующие пользователи обрабатываются только после полного запроса LDAP.',
                        safetyDescription:
                            'Неудачный запрос, тайм-аут или неполный постраничный результат никогда не меняют статус пользователя. Область синхронизации соответствует пользователю Base DN, фильтру и сопоставлению атрибутов.',
                        runNow: 'Синхронизировать сейчас',
                        lastRunSuccess: 'Последняя синхронизация завершилась успешно: {0}.',
                        lastRunFailed: 'Последняя синхронизация не удалась: {0}.',
                        lastRunRunning: 'Синхронизация началась: {0}',
                        sourceDisabled: 'Включите и сохраните AD/LDAP перед запуском синхронизации.',
                        cronRequired: 'Введите выражение Cron.',
                        saveBeforeRun: 'Сохраните настройки синхронизации перед запуском задачи.',
                        runConfirmTitle: 'Запустить строгую синхронизацию',
                        runConfirmDescription:
                            'Пользователи LDAP, отсутствующие в полном запросе, будут отключены, а их активные сеансы удалены. Продолжать?',
                        runSuccess: 'Синхронизация LDAP завершена.',
                        weekdays: {
                            0: 'воскресенье',
                            1: 'понедельник',
                            2: 'вторник',
                    ...
                    syncLogs: {
                        title: 'Синхронизировать журналы',
                        description: 'Просмотрите результаты запланированной и ручной синхронизации LDAP.',
                        ...
                        running: 'Выполняется',
                        result: 'Результат',
                        resultSummary: 'Создано {0}, обновлено {1}, отсутствует {2}',
                        duration: 'Продолжительность',
                        action: 'Действие',
                    },
                    testLoginTitle: 'Проверка входа AD/LDAP',
                    testLoginDesc:
                        'Привяжите учетные данные пользователя AD/LDAP только для проверки аутентификации. Сеанс 1Panel не создается.',
                    ldapUsername: 'Имя пользователя LDAP',
                    usernameRequired: 'Введите имя пользователя LDAP.',
                    startTest: 'Начать тест',
                    testLoginSuccess: 'Аутентификация прошла успешно.',
                    testLoginSuccessWithDN: 'Аутентификация прошла успешно. Пользователь DN: {0}',
                    import: {
                        title: 'Импорт пользователей AD/LDAP',
                        source: 'Источник данных: каталог AD/LDAP.',
                        lastRead: 'Последнее чтение: {0}',
                        cacheHit: 'Кэшированный результат',
                        keywordPlaceholder: 'Поиск имени пользователя',
                        search: 'Поиск',
                        refresh: 'Читать из LDAP',
                        refreshTip: 'Игнорируйте кратковременный кеш и снова прочитайте каталог LDAP.',
                        loadFailed: 'Не удалось прочитать каталог LDAP.',
                        retry: 'Повторить попытку',
                        noData: 'Пользователи каталога не найдены.',
                        username: 'Имя пользователя',
                        status: 'Статус',
                        changes: 'Изменения',
                        noChanges: 'Никаких изменений',
                        importable: 'Готов к импорту',
                        updateAvailable: 'Доступно обновление',
                        upToDate: 'Актуально',
                        conflict: 'Конфликт имен',
                        selectedCount: '{0} выбрано',
                        totalCount: '{0} пользователей',
                        newUserRole: 'Новая роль пользователя',
                        newUserRoleRequired: 'Выберите роль для новых пользователей.',
                        noNewUsers: 'В этой операции нет новых пользователей.',
                        roleOnlyForNewUsers: 'Выбранная роль применяется только к вновь созданным пользователям.',
                        strictOff: 'Строгая синхронизация отключена. Полный импорт не отключит пользователей.',
                        importSelected: 'Выбран импорт/обновление ({0})',
                        importAll: 'Импортировать/обновить все ({0})',
                        previewTitle: 'Подтвердить полный импорт',
                        previewDesc:
                            'Полный каталог LDAP был прочитан. Ключевое слово поиска не ограничивает эту операцию.',
                        created: 'Создать',
                        updated: 'Обновить',
                        unchanged: 'Без изменений',
                        conflicts: 'Конфликты',
                        ...
                        reactivated: 'Повторно активировать',
                        strictWarning:
                            'Строгая синхронизация включена. Пользователи, отсутствующие в LDAP, не могут войти в систему, но их записи, роли и разрешения сохраняются.',
                        missingUsers: 'Пользователи отсутствуют в LDAP',
                        missingScope: 'Затрагивается только этот источник LDAP.',
                        willDisable: 'Будет отключен',
                        confirmAll: 'Подтвердить импорт',
                        confirmAllWithMissing: 'Подтвердить импорт и отключить {0} пользователей',
                        executeSuccess: 'Пользователи LDAP обработаны успешно.',
                        queryExpired: 'Срок действия каталога истек. Прочтите еще раз LDAP.',
                        planIncomplete: 'Полное чтение каталога неполное и не может быть выполнено.',
                    },
                },
            },
        },
