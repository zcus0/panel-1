...
const message = {
    ...
    xpack: {
        ldap: {
            source: 'Sumber',
            directoryMissing: 'Tiada dalam LDAP',
            localCredentialsManaged:
                'Nama pengguna dan kata laluan diurus oleh LDAP dan tidak boleh diubah secara setempat.',
            sources: {
                local: 'Setempat',
                ldap: 'LDAP',
            },
            importUsers: 'Import pengguna AD/LDAP',
            searchUsersPlaceholder: 'Cari nama pengguna',
            readFromLDAP: 'Baca daripada LDAP',
            selectedUsers: '{0} dipilih',
            queriedAt: 'Masa dibaca',
            cachedResult: 'Hasil cache',
            roleForNewUsers: 'Peranan untuk pengguna baharu',
            selectRole: 'Pilih peranan',
            roleOnlyForNewUsers: 'Peranan diperlukan hanya apabila import mencipta pengguna.',
            roleRequiredForNewUsers: 'Pilih peranan untuk pengguna LDAP baharu.',
            changedFields: 'Medan ditukar',
            importSelected: 'Import dipilih',
            importAll: 'Import semua',
            importPreview: 'Pratonton import AD/LDAP',
            importCompleted: 'Import AD/LDAP selesai',
            incompletePreview: 'Direktori LDAP dibaca tidak lengkap. Baca dari LDAP sekali lagi.',
            missingUsersWarning: 'Pengguna yang hilang dari LDAP akan dilumpuhkan oleh penyegerakan yang ketat.',
            missingUsersWarningDetail: '{0} pengguna LDAP tempatan tidak akan dapat log masuk lagi.',
            action: 'Tindakan',
            reason: 'Sebab',
            noImportChanges: 'Tiada perubahan import',
            confirmImport: 'Sahkan import',
            created: 'Buat',
            updated: 'Kemas kini',
            reactivated: 'Aktifkan semula',
            unchanged: 'Tidak berubah',
            conflicts: 'Konflik',
            missing: 'hilang',
            missingUsersConfirm: '{0} pengguna yang tiada dalam LDAP akan dinyahdayakan dan dilog keluar. Teruskan?',
            strictSyncConfirm: 'Sahkan penyegerakan yang ketat',
            status: {
                importable: 'Pengguna baharu',
            ...
            fields: {
                name: 'Nama pengguna',
                externalDN: 'Direktori DN',
                externalID: 'ID Luaran',
                authSourceStatus: 'Status pengesahan',
            },
            actions: {
                created: 'Buat',
                updated: 'Kemas kini',
        ...
        user: {
            ...
            auth: {
                ...
                providerDescriptions: {
                    ldap: 'Serasi dengan Active Directory, OpenLDAP dan perkhidmatan LDAP yang lain',
                    passkey: 'Gunakan bukti kelayakan peranti untuk log masuk tanpa kata laluan',
                    radius: 'Sahkan akses rangkaian melalui perkhidmatan Radius',
                    oidc: 'Sambungkan log masuk tunggal perusahaan dengan OpenID Connect',
                    saml2: 'Gunakan SAML2 untuk persekutuan identiti perusahaan',
                    cas: 'Sambungkan perkhidmatan pengesahan berpusat untuk log masuk tunggal',
                    oauth2: 'Sambungkan perkhidmatan identiti OAuth2 yang serasi',
                    dingtalk: 'Gunakan identiti organisasi DingTalk dan log masuk QR',
                    feishu: 'Gunakan identiti organisasi Feishu dan penyegerakan akaun',
                    wecom: 'Sahkan dengan identiti ahli WeCom',
                },
                planned: 'Terancang',
                plannedTitle: 'Tetapan pengesahan {0}',
                plannedDesc: 'Pembekal pengesahan ini telah dirancang dan belum tersedia lagi.',
                ldap: {
                    enable: 'Dayakan',
                    enabled: 'Didayakan',
                    disabled: 'Dilumpuhkan',
                    connection: 'Sambungan asas',
                    connectionDesc:
                        'Konfigurasikan perkhidmatan direktori dan akaun bind yang digunakan untuk mencari pengguna.',
                    serverURL: 'URL pelayan',
                    serverURLHelper: 'Menyokong URL ldap:// dan ldaps://.',
                    userBaseDN: 'Pengguna Base DN',
                    userBaseDNHelper:
                        'Memulakan DN untuk carian pengguna LDAP; ia boleh menjadi OU, CN atau akar domain DN.',
                    bindDN: 'Ikat DN',
                    bindPassword: 'Kata laluan',
                    ...
                    testLogin: 'Uji log masuk',
                    userImport: 'Import pengguna',
                    saveBeforeImport: 'Simpan tetapan AD/LDAP semasa sebelum mengimport pengguna.',
                    format: 'Format',
                    restoreExample: 'Pulihkan contoh',
                    mappingValid: 'JSON sah; name dikonfigurasikan.',
                    mappingInvalid: 'Masukkan JSON yang sah.',
                    mappingObject: 'Pemetaan atribut mestilah objek JSON.',
                    mappingOnlyName: 'Hanya pemetaan name disokong.',
                    mappingStringValues: 'Setiap atribut yang dipetakan mestilah rentetan.',
                    mappingNameRequired: 'name mestilah rentetan bukan kosong.',
                    restored: 'Tetapan terakhir yang disimpan telah dipulihkan.',
                    connectionTestSuccess: 'Ujian sambungan LDAP berjaya.',
                    recentTestSuccess: 'Ujian terakhir berjaya: {0}',
                    recentTestFailed: 'Ujian terakhir gagal: {0}',
                    serverURLRequired: 'Masukkan URL pelayan LDAP.',
                    serverURLInvalid: 'Gunakan URL ldap:// atau ldaps:// yang sah.',
                    userBaseDNRequired: 'Masukkan Pengguna Base DN.',
                    bindDNRequired: 'Masukkan Bind DN.',
                    passwordRequired: 'Masukkan kata laluan.',
                    userFilterRequired: 'Masukkan penapis pengguna.',
                    connectTimeoutRequired: 'Masukkan tamat masa sambungan.',
                    searchPageSizeRequired: 'Masukkan saiz halaman pertanyaan LDAP.',
                    sync: {
                        ...
                        daily: 'Setiap hari',
                        weekly: 'Mingguan',
                        customCron: 'Cron tersuai',
                        preview: 'Pratonton',
                        previewTitle: '5 pelaksanaan seterusnya',
                        previewEmpty: 'Tiada masa pelaksanaan tersedia',
                        cronHelper: 'Gunakan ungkapan Cron lima medan standard: minit, jam, hari, bulan, hari bekerja.',
                        autoImport: 'Import pengguna baharu',
                        autoImportHelper:
                            'Apabila dilumpuhkan, hanya pengecam dan status direktori dikekalkan untuk pengguna LDAP yang diimport; tiada pengguna baharu dibuat.',
                        defaultRole: 'Peranan pengguna baharu',
                        ...
                        lastRunRunning: 'Penyegerakan dimulakan: {0}',
                        sourceDisabled: 'Dayakan dan simpan AD/LDAP sebelum menjalankan penyegerakan.',
                        cronRequired: 'Masukkan ungkapan Cron.',
                    ...
                    syncLogs: {
                        title: 'Segerakkan log',
                        description: 'Semak keputusan penyegerakan LDAP yang dijadualkan dan manual.',
                        startedAt: 'Masa mula',
                        trigger: 'Cara pelaksanaan',
                        manual: 'Manual',
                        ...
                        running: 'Sedang berjalan',
                        result: 'Hasilnya',
                        resultSummary: 'Dicipta {0}, dikemas kini {1}, tiada {2}',
                        duration: 'Tempoh',
                        action: 'Tindakan',
                    },
                    ...
                    testLoginSuccess: 'Pengesahan berjaya.',
                    testLoginSuccessWithDN: 'Pengesahan berjaya. Pengguna DN: {0}',
                    import: {
                        title: 'Import pengguna AD/LDAP',
                        source: 'Sumber data: direktori AD/LDAP',
                        lastRead: 'Bacaan terakhir: {0}',
                        cacheHit: 'Hasil cache',
                        keywordPlaceholder: 'Cari nama pengguna',
                        search: 'Cari',
                        refresh: 'Baca daripada LDAP',
                        refreshTip: 'Abaikan cache jangka pendek dan baca direktori LDAP sekali lagi.',
                        loadFailed: 'Gagal membaca direktori LDAP.',
                        retry: 'Cuba semula',
                        noData: 'Tiada pengguna direktori ditemui.',
                        username: 'Nama pengguna',
                        status: 'Status',
                        changes: 'Perubahan',
                        noChanges: 'Tiada perubahan',
                        importable: 'Sedia untuk diimport',
                        updateAvailable: 'Kemas kini tersedia',
                        upToDate: 'Terkini',
                        conflict: 'Konflik nama',
                        selectedCount: '{0} dipilih',
                        totalCount: '{0} pengguna',
                        newUserRole: 'Peranan pengguna baharu',
                        newUserRoleRequired: 'Pilih peranan untuk pengguna baharu.',
                        noNewUsers: 'Tiada pengguna baharu dalam operasi ini.',
                        roleOnlyForNewUsers: 'Peranan yang dipilih hanya digunakan kepada pengguna yang baru dibuat.',
                        strictOff: 'Penyegerakan yang ketat dilumpuhkan. Import penuh tidak akan melumpuhkan pengguna.',
                        importSelected: 'Import/kemas kini dipilih ({0})',
                        importAll: 'Import/kemas kini semua ({0})',
                        previewTitle: 'Sahkan import penuh',
                        previewDesc:
                            'Direktori LDAP lengkap telah dibaca. Kata kunci carian tidak mengehadkan operasi ini.',
                        created: 'Buat',
                        updated: 'Kemas kini',
                        unchanged: 'Tidak berubah',
                        conflicts: 'Konflik',
                        ...
                        reactivated: 'Aktifkan semula',
                        strictWarning:
                            'Penyegerakan yang ketat didayakan. Pengguna yang tiada dari LDAP tidak boleh log masuk, tetapi rekod, peranan dan kebenaran mereka dikekalkan.',
                        missingUsers: 'Pengguna hilang dari LDAP',
                        missingScope: 'Hanya sumber LDAP ini terjejas.',
                        willDisable: 'Akan dilumpuhkan',
                        confirmAll: 'Sahkan import',
                        confirmAllWithMissing: 'Sahkan import dan nyahdayakan {0} pengguna',
                        executeSuccess: 'Pengguna LDAP telah berjaya diproses.',
                        queryExpired: 'Keputusan direktori telah tamat tempoh. Baca dari LDAP sekali lagi.',
                        planIncomplete: 'Direktori penuh dibaca tidak lengkap dan tidak boleh dilaksanakan.',
                    },
                },
            },
        },
