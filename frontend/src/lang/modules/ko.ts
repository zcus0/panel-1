...
const message = {
    ...
    aiTools: {
        agents: {
            ...
            discoverModelsFailedUseDefaults: '모델을 가져오지 못했습니다. 기본 모델을 사용합니다.',
            ...
            customImageURLHelper:
                'Custom 계정에는 전체 이미지 생성 엔드포인트 URL을 입력하세요. 경로는 자동으로 추가되지 않습니다. 예: {0}',
            apiTypeBaseURLMismatch: '현재 Base URL은 {0} 경로처럼 보이지만 {1}이 선택되었습니다. 권장 URL: {2}',
            validateAvailability: '계정 가용성 확인',
            validateAvailabilityHelper: '저장 전에 최소 메시지를 보내 API를 확인합니다',
            validateImageAvailabilityHelper: '저장 전에 최소 이미지 한 장을 생성하며 비용이 발생할 수 있습니다',
        },
        model: {
            model: '모델',
            localModel: '로컬 모델',
    ...
    xpack: {
        ldap: {
            source: '소스',
            directoryMissing: 'LDAP에 없음',
            localCredentialsManaged:
                '이 사용자의 사용자 이름과 비밀번호는 LDAP에서 관리되므로 로컬에서 변경할 수 없습니다.',
            sources: {
                local: '로컬',
                ldap: 'LDAP',
            },
            importUsers: 'AD/LDAP 사용자 가져오기',
            searchUsersPlaceholder: '사용자 이름 검색',
            readFromLDAP: 'LDAP에서 읽기',
            selectedUsers: '{0} 선택됨',
            queriedAt: '읽기 시간',
            cachedResult: '캐시된 결과',
            roleForNewUsers: '신규 사용자의 역할',
            selectRole: '역할 선택',
            roleOnlyForNewUsers: '가져오기를 통해 사용자가 생성되는 경우에만 역할이 필요합니다.',
            roleRequiredForNewUsers: '새로운 LDAP 사용자의 역할을 선택합니다.',
            changedFields: '변경된 필드',
            importSelected: '선택 항목 가져오기',
            importAll: '모두 가져오기',
            importPreview: 'AD/LDAP 가져오기 미리보기',
            importCompleted: 'AD/LDAP 가져오기 완료',
            incompletePreview: 'LDAP 디렉터리 읽기가 완료되지 않았습니다. LDAP에서 다시 읽어보세요.',
            missingUsersWarning: 'LDAP에서 누락된 사용자는 엄격한 동기화로 인해 비활성화됩니다.',
            missingUsersWarningDetail: '{0} 로컬 LDAP 사용자는 더 이상 로그인할 수 없습니다.',
            action: '액션',
            reason: '이유',
            noImportChanges: '가져오기 변경사항 없음',
            ...
            conflicts: '충돌',
            missing: '누락',
            missingUsersConfirm: 'LDAP에서 누락된 {0}명의 사용자를 비활성화하고 로그아웃합니다. 계속하시겠습니까?',
            strictSyncConfirm: '엄격한 동기화 확인',
            status: {
                importable: '신규 사용자',
        ...
        user: {
            ...
            auth: {
                ...
                providerDescriptions: {
                    ldap: 'Active Directory, OpenLDAP 및 기타 LDAP 서비스와 호환 가능',
                    passkey: '비밀번호 없는 로그인을 위해 장치 자격 증명 사용',
                    radius: 'Radius 서비스를 통해 네트워크 액세스 인증',
                    oidc: 'OpenID Connect로 엔터프라이즈 Single Sign-On 연결',
                    saml2: '기업 ID 연동을 위해 SAML2 사용',
                    cas: 'Single Sign-On을 위한 중앙 집중식 인증 서비스 연결',
                    oauth2: '호환 가능한 OAuth2 ID 서비스 연결',
                    dingtalk: 'DingTalk 조직 ID 및 QR 로그인 사용',
                    feishu: 'Feishu 조직 ID 및 계정 동기화 사용',
                    wecom: 'WeCom 회원 본인 인증',
                },
                planned: '예정',
                plannedTitle: '{0} 인증 설정',
                plannedDesc: '이 인증 공급자는 계획되어 있으며 아직 사용할 수 없습니다.',
                ldap: {
                    enable: '활성화',
                    enabled: '활성화됨',
                    disabled: '비활성화됨',
                    connection: '기본 연결',
                    connectionDesc: '사용자 검색에 사용되는 디렉터리 서비스와 바인딩 계정을 구성합니다.',
                    serverURL: '서버 URL',
                    serverURLHelper: 'ldap:// 및 ldaps:// URL을 지원합니다.',
                    userBaseDN: '사용자 Base DN',
                    userBaseDNHelper: 'LDAP 사용자 검색을 위해 DN 시작 OU, CN 또는 도메인 루트 DN일 수 있습니다.',
                    bindDN: 'DN 바인딩',
                    bindPassword: '비밀번호',
                    ...
                    testLogin: '로그인 테스트',
                    userImport: '사용자 가져오기',
                    saveBeforeImport: '사용자를 가져오기 전에 현재 AD/LDAP 설정을 저장하십시오.',
                    format: '형식',
                    restoreExample: '복원 예시',
                    mappingValid: '유효한 JSON; name가 구성되었습니다.',
                    mappingInvalid: '유효한 JSON를 입력하세요.',
                    mappingObject: '속성 매핑은 JSON 개체여야 합니다.',
                    mappingOnlyName: 'name 매핑만 지원됩니다.',
                    mappingStringValues: '매핑된 모든 속성은 문자열이어야 합니다.',
                    mappingNameRequired: 'name는 비어 있지 않은 문자열이어야 합니다.',
                    restored: '마지막으로 저장된 설정이 복원되었습니다.',
                    connectionTestSuccess: 'LDAP 연결 테스트에 성공했습니다.',
                    recentTestSuccess: '마지막 테스트 성공: {0}',
                    recentTestFailed: '마지막 테스트 실패: {0}',
                    serverURLRequired: 'LDAP 서버 URL을 입력하세요.',
                    serverURLInvalid: '유효한 ldap:// 또는 ldaps:// URL을 사용하세요.',
                    userBaseDNRequired: '사용자 Base DN를 입력합니다.',
                    bindDNRequired: '바인딩 DN를 입력합니다.',
                    passwordRequired: '비밀번호를 입력하세요.',
                    userFilterRequired: '사용자 필터를 입력하세요.',
                    connectTimeoutRequired: '연결 시간 초과를 입력합니다.',
                    ...
                    sync: {
                        ...
                        customCron: '커스텀 Cron',
                        preview: '미리보기',
                        previewTitle: '다음 5회 실행',
                        previewEmpty: '사용 가능한 실행 시간이 없습니다.',
                        cronHelper: '표준 5개 필드 Cron 표현식(분, 시, 일, 월, 요일)을 사용합니다.',
                        autoImport: '새 사용자 가져오기',
                        autoImportHelper:
                            '비활성화되면 가져온 LDAP 사용자에 대해 디렉터리 식별자와 상태만 유지됩니다. 새로운 사용자가 생성되지 않습니다.',
                        defaultRole: '새로운 사용자 역할',
                        defaultRolePlaceholder: '역할 선택',
                        ...
                        lastRunRunning: '동기화 시작됨: {0}',
                        sourceDisabled: '동기화를 실행하기 전에 AD/LDAP를 활성화하고 저장하세요.',
                    ...
                    syncLogs: {
                        title: '동기화 로그',
                        description: '예약된 및 수동 LDAP 동기화 결과를 검토합니다.',
                        startedAt: '시작 시간',
                        trigger: '실행 방식',
                        manual: '수동',
                        scheduled: '예정됨',
                        ...
                        running: '실행 중',
                        result: '결과',
                        resultSummary: '{0} 생성, {1} 업데이트, {2} 누락',
                        duration: '기간',
                        action: '액션',
                    },
                    ...
                    startTest: '테스트 시작',
                    testLoginSuccess: '인증에 성공했습니다.',
                    testLoginSuccessWithDN: '인증에 성공했습니다. 사용자 DN: {0}',
                    import: {
                        title: 'AD/LDAP 사용자 가져오기',
                        source: '데이터 소스: AD/LDAP 디렉토리',
                        lastRead: '마지막으로 읽은 날짜: {0}',
                        cacheHit: '캐시된 결과',
                        keywordPlaceholder: '사용자 이름 검색',
                        search: '검색',
                        refresh: 'LDAP에서 읽기',
                        refreshTip: '단기 캐시를 무시하고 LDAP 디렉토리를 다시 읽으십시오.',
                        loadFailed: 'LDAP 디렉터리를 읽지 못했습니다.',
                        retry: '재시도',
                        noData: '디렉터리 사용자를 찾을 수 없습니다.',
                        username: '사용자 이름',
                        status: '상태',
                        changes: '변경 사항',
                        noChanges: '변경사항 없음',
                        importable: '가져올 준비가 되었습니다.',
                        updateAvailable: '업데이트 가능',
                        upToDate: '최신',
                        conflict: '이름 충돌',
                        selectedCount: '{0} 선택됨',
                        totalCount: '{0}명',
                        newUserRole: '새로운 사용자 역할',
                        newUserRoleRequired: '새 사용자의 역할을 선택합니다.',
                        noNewUsers: '이 작업에는 새로운 사용자가 없습니다.',
                        roleOnlyForNewUsers: '선택한 역할은 새로 생성된 사용자에게만 적용됩니다.',
                        strictOff:
                            '엄격한 동기화가 비활성화되었습니다. 전체 가져오기는 사용자를 비활성화하지 않습니다.',
                        importSelected: '가져오기/업데이트 선택됨({0})',
                        importAll: '모두 가져오기/업데이트({0})',
                        previewTitle: '전체 가져오기 확인',
                        previewDesc: '전체 LDAP 디렉토리를 읽었습니다. 검색 키워드는 이 작업을 제한하지 않습니다.',
                        created: '만들기',
                        updated: '업데이트',
                        unchanged: '변경되지 않음',
                        conflicts: '충돌',
                        ...
                        reactivated: '재활성화',
                        strictWarning:
                            '엄격한 동기화가 활성화되었습니다. LDAP에서 누락된 사용자는 로그인할 수 없지만 해당 기록, 역할 및 권한은 유지됩니다.',
                        missingUsers: 'LDAP에서 누락된 사용자',
                        missingScope: '이 LDAP 소스만 영향을 받습니다.',
                        willDisable: '비활성화됩니다',
                        confirmAll: '가져오기 확인',
                        confirmAllWithMissing: '가져오기를 확인하고 {0}명의 사용자 비활성화',
                        executeSuccess: 'LDAP 사용자가 성공적으로 처리되었습니다.',
                        queryExpired: '디렉터리 결과가 만료되었습니다. LDAP에서 다시 읽어보세요.',
                        planIncomplete: '전체 디렉터리 읽기가 불완전하여 실행할 수 없습니다.',
                    },
                },
            },
        },
